...
namespace STP.Common.Log
{
    internal class LogWrapper : ILogWrapper
    {
        ...
        private static volatile LogWrapper instance;
        ...
        internal static LogWrapper Instance
        {
            [DebuggerStepThrough]
            get
            {
                ...
                if (instance == null)
                {
                    lock (syncLock)
                    {
                        if (instance == null)
                        {
                            return instance = new LogWrapper();
                        }
                    }
                }
                return instance;
        ...
        #region LogWrapper instance

        //private const string PolicyName = "LogWrapper";
