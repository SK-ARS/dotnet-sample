      ...
      <body style="font-family:Arial">
        ...
        <xsl:for-each select="ns1:RouteParts/ns2:RoutePartListPosition">
          ...
          <xsl:if test="$ClassificationCategory != ''">
            <!--<xsl:choose>-->
            <!--For Semi Vehicles-->
            <xsl:if test="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:SemiVehicle/ns3:Summary != '' and
					ns3:VehicleSummary/ns3:Configuration/ns3:SemiVehicle/ns3:AxleConfiguration/ns3:AxleWeightListPosition/ns3:AxleWeight != '' and 
                    ns3:VehicleSummary/ns3:Configuration/ns3:SemiVehicle/ns3:AxleConfiguration/ns3:AxleWeightListPosition/ns3:AxleWeight != '0'">
            ...
            <xsl:if test="(ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:NonSemiVehicle/ns3:ComponentListPosition/ns3:Component/ns3:DrawbarTractor/ns3:Summary != '' 
                  or ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:NonSemiVehicle/ns3:ComponentListPosition/ns3:Component/ns3:LoadBearing/ns3:Summary != '') and
					(ns3:Component/ns3:DrawbarTractor/ns3:AxleConfiguration/ns3:AxleWeightListPosition/ns3:AxleWeight != '' and 
              ...
              <tr>
                ...
                <td  width="75%" valign="top">
                  <xsl:choose>
                    ...
                    <xsl:when test="contains(ns3:VehicleSummary/ns3:Configuration/ns3:TrackedVehicle/ns3:GrossWeight/ns3:Weight, '##**##')">
                      <xsl:if test="substring-after(ns3:VehicleSummary/ns3:Configuration/ns3:TrackedVehicle/ns3:GrossWeight/ns3:Weight, '##**##') != ''">
                        <xsl:value-of select="substring-after(ns3:VehicleSummary/ns3:Configuration/ns3:TrackedVehicle/ns3:GrossWeight/ns3:Weight, '##**##')"/>
                        <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>kg
                      </xsl:if>
                    </xsl:when>

                    <xsl:when test="ns3:VehicleSummary/ns3:Configuration/ns3:TrackedVehicle/ns3:GrossWeight/ns3:Weight != ''">
                      <xsl:value-of select="ns3:VehicleSummary/ns3:Configuration/ns3:TrackedVehicle/ns3:GrossWeight/ns3:Weight"/>
                      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>kg
                    </xsl:when>
