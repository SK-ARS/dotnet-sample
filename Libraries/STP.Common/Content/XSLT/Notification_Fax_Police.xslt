      ...
      <body style="font-family:Arial">
        ...
        <table width = "100%" cellspacing ="0" cellpadding ="0">
          ...
          <tr>
            ...
            <td valign ="top" colspan="3" align="left">
              <br></br>
              <xsl:value-of select="ns1:JourneyFromToSummary/ns2:From" /> to  <xsl:value-of select="ns1:JourneyFromToSummary/ns2:To"/>
        ...
        <table border = "1" width = "100%">
          ...
          <xsl:variable name="splitRouteDescription">
            <xsl:call-template name="tokenize">
              <xsl:with-param name="pText" select="substring(ns1:RouteParts/ns2:RoutePartListPosition/ns2:Route,1,$valueLength)"></xsl:with-param>
          ...
          <xsl:if test="$UnitType=692002">
            ...
            <xsl:variable name="splitRouteDescription">
              <xsl:call-template name="tokenize">
                <xsl:with-param name="pText" select="substring(ns1:RouteParts/ns2:RoutePartListPosition/ns2:RouteImperial,1,$valueLength)"></xsl:with-param>
                <xsl:with-param name="pDelim" select="Leg"></xsl:with-param>
              </xsl:call-template>
            </xsl:variable>
          </xsl:if>-->
        ...
        <xsl:for-each select="ns1:RouteParts/ns2:RoutePartListPosition">
          ...
          <xsl:if test="$ClassificationCategory != ''">
            <!--<xsl:choose>-->
            <!--For Semi Vehicles-->
            <xsl:if test="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:SemiVehicle/ns3:Summary != ''">
            ...
            <xsl:if test="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:NonSemiVehicle/ns3:ComponentListPosition/ns3:Component/ns3:DrawbarTractor/ns3:Summary != '' 
                  or ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:NonSemiVehicle/ns3:ComponentListPosition/ns3:Component/ns3:LoadBearing/ns3:Summary != '' ">
