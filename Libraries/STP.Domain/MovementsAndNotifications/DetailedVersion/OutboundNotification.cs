...
namespace STP.Domain.MovementsAndNotifications.DetailedVersion
{
    ...
    public partial class OutboundNotification
    {
        ...
        private byte dftReferenceField;

        private OutboundNotificationHaulierDetails haulierDetailsField;

        private object hauliersReferenceField;

        private object clientNameField;
        ...
        private object notificationOnEscortField;
        ...
        /// <remarks/>
        public object HauliersReference
        {
            get
            {
        ...
        /// <remarks/>
        public object NotificationOnEscort
        {
            get
            {
    ...
    public partial class ContactOnbehalfOf
    {
        ...
        private bool wantsFailureAlertFieldSpecified;
        ...
        public bool WantsFailureAlertSpecified
        {
            get
            {
                return this.wantsFailureAlertFieldSpecified;
            }
            set
            {
                this.wantsFailureAlertFieldSpecified = value;
            }
        }
    }
    ...
    public partial class DrivingInstructionsSubPartListPositionSubPartAlternativeListPositionAlternativeInstructionListPositionInstructionNavigationDistance
    {
        ...
        private uint measuredMetricField;

        private uint displayMetricField;

        private uint displayImperialField;

        /// <remarks/>
        public uint MeasuredMetric
        {
            get
            {
