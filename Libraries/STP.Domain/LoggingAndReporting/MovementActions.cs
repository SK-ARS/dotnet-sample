            ...
            try
            {
                switch (ObjMovAct.MovementActionType)
                {
                    ...
                    case MovementnActionType.sort_desktop_withdraws_appl: //sort desktop withdraws application
                        ...
                        break;
                    case MovementnActionType.sort_desktop_unwithdraw:
                        MovementDescription = "The application was unwithdrawn by SORT user '" + ObjMovAct.ContactName + "'." + helpDeskUserstring;
                        break;
                    ...
                    case MovementnActionType.outbound_doc_delivered: //outbound document delivered
                        MovementDescription = "The outbound document '" + ObjMovAct.ESDALRef + "' has been delivered to '" + ObjMovAct.ReciverContactName + "' at '" + ObjMovAct.OrganisationNameReceiver + "' via '" + ObjMovAct.ContactPreference.ToString() + "'" + helpDeskUserstring;
                        break;
                    ...
                    case MovementnActionType.outbound_document_retransmitted: //outbound document retransmitted
                        MovementDescription = "The outbound document '" + ObjMovAct.ESDALRef + "' is ready for redelivery to '" + ObjMovAct.OrganisationNameReceiver + "' at '" + ObjMovAct.OrganisationNameSender + "'" + helpDeskUserstring;
                        break;
                    #endregion

                    #region Transmission
                    case MovementnActionType.transmission_delivered: //transmission delivered
                        MovementDescription = "The transmission for '" + ObjMovAct.ESDALRef + "' of type " + ObjMovAct.TransmissionDocType + " has been delivered to " + ObjMovAct.OrganisationNameReceiver + " (started sending " + ObjMovAct.DateTime + ")" + helpDeskUserstring;
                        break;
                    case MovementnActionType.transmission_delivery_failure: //transmission delivery failure
                        MovementDescription = "The transmission for '" + ObjMovAct.ESDALRef + "' of type " + ObjMovAct.TransmissionDocType + " has failed to deliver " + ObjMovAct.OrganisationNameReceiver + " due to '" + ObjMovAct.TransmissionErrorMsg + "' (started sending " + ObjMovAct.DateTime + ")" + helpDeskUserstring;
                        break;
                    case MovementnActionType.transmission_ready_for_delivery: //transmission ready for delivery
                        MovementDescription = "The transmission for '" + ObjMovAct.ESDALRef + "' of type " + ObjMovAct.TransmissionDocType + " is ready for delivery to " + ObjMovAct.OrganisationNameReceiver + "" + helpDeskUserstring;
                        break;
                    case MovementnActionType.transmission_delivery_retry: //transmission delivery retry
                        MovementDescription = "Retrying delivery of transmission for'" + ObjMovAct.ESDALRef + "' of type " + ObjMovAct.TransmissionDocType + " via " + ObjMovAct.ContactPreference.ToString() + "" + helpDeskUserstring;
                        break;
                    case MovementnActionType.transmission_forwarded: //transmission forwarded
                        MovementDescription = "The transmission for " + ObjMovAct.ESDALRef + " of type " + ObjMovAct.TransmissionDocType + " has been forwarded to " + ObjMovAct.OrganisationNameReceiver + " via "+ ObjMovAct.ContactPreference.ToString() + " (started sending " + ObjMovAct.DateTime + ")" + helpDeskUserstring;
                        break;
                    case MovementnActionType.transmission_sent: //transmission sent
                        MovementDescription = "The transmission for '" + ObjMovAct.ESDALRef + "' of type " + ObjMovAct.TransmissionDocType + " has been sent to " + ObjMovAct.OrganisationNameReceiver + " via " + ObjMovAct.ContactPreference.ToString() + "" + helpDeskUserstring;
                        break;
                    case MovementnActionType.transmission_status_changed: //transmission status changed
                        MovementDescription = "Movement transmission for'" + ObjMovAct.ESDALRef + "', mechanism '" + ObjMovAct.TransmissionModel.InboxOnly + "', status was '" + ObjMovAct.TransmissionModelFilter.Pending + "', is now '" + ObjMovAct.TransmissionModelFilter.Delivered + "', overall '" + ObjMovAct.TransmissionModelFilter.Pending + "'. It was destined for organisation '" + ObjMovAct.OrganisationNameReceiver + "', recipient '" + ObjMovAct.ReciverContactName + "'. " + helpDeskUserstring;
                        break;
                    #endregion
                    ...
                    case MovementnActionType.notification_collaboration_made: //notification collaboration made
                        MovementDescription = "Collaborator '" + userInfo.UserName + "' has added a collaboration note '" + ObjMovAct.CollaborationNotes + "' against notification '" + ObjMovAct.NotificationCode + "'" + helpDeskUserstring;
                        break;
                    ...
                    case MovementnActionType.user_creates_candidate_ver_from_revised_app_ver: //user creates special order
                        ...
                        break;
                    case MovementnActionType.user_creates_candidate_ver_from_revised_candidate_ver: //user creates special order
                        MovementDescription = "User '" + ObjMovAct.ContactName + "' has created candidate route version '" + ObjMovAct.CandVerNo + "' from revised candidate route version '" + ObjMovAct.ESDALRef + "'." + helpDeskUserstring;
                        break;
                    case MovementnActionType.notification_process_completed:
                        MovementDescription = "The notification '" + ObjMovAct.NotificationCode + "' was submitted by haulier '" + userInfo.UserName + "'." + helpDeskUserstring;
                        break;
                    case MovementnActionType.haulier_notification_renotified:
                        MovementDescription = "The notification '" + ObjMovAct.ESDALRef + "' was renotified by haulier '" + userInfo.UserName + "'." + helpDeskUserstring;// + " The renotified ESDAL reference number is '" + ObjMovAct.NewNotificationCode + "'.";
                        break;
                    case MovementnActionType.haulier_notification_cloned:
                        MovementDescription = "The notification '" + ObjMovAct.ESDALRef + "'  was cloned by haulier '" + userInfo.UserName + "'." + helpDeskUserstring;
                        break;
                    case MovementnActionType.haulier_notifcation_revised: 
                        MovementDescription = "The notification '" + ObjMovAct.ESDALRef + "'  was revised by haulier '" + userInfo.UserName + "'." + helpDeskUserstring;
                        break;
                    case MovementnActionType.haulier_distributed_notification_to_soa: 
                        MovementDescription = "The notification '" + ObjMovAct.ESDALRef + "' was distributed by haulier '" + userInfo.UserName + "' to SOA '" + ObjMovAct.CheckerName + "'." + helpDeskUserstring;
                        break;
                    case MovementnActionType.haulier_distributed_notification_to_police:
                        MovementDescription = "The notification '" + ObjMovAct.ESDALRef + "' was distributed by haulier '" + userInfo.UserName + "' to Police '" + ObjMovAct.CheckerName + "'." + helpDeskUserstring;
                        break;
                    case MovementnActionType.soa_modify_route:
                        MovementDescription = "'" + ObjMovAct.NENRouteName + "' Route is edited inside NE notification '" + ObjMovAct.NENNotificationNo + "' by SOA '" + userInfo.UserName + "' on '" + ObjMovAct.DateTime + "' ." + helpDeskUserstring;
                        break;
                    case MovementnActionType.police_modify_route:
                        MovementDescription = "'" + ObjMovAct.NENRouteName + "' Route is edited inside NE notification '" + ObjMovAct.NENNotificationNo + "' by Police '" + userInfo.UserName + "' on '" + ObjMovAct.DateTime + "' ." + helpDeskUserstring;
                        break;
                    case MovementnActionType.soa_sent_email_to_haulier:
                        MovementDescription = "SOA '" + userInfo.UserName + "' sent email to haulier '" + ObjMovAct.HaulierName + "'." + helpDeskUserstring;
                        break;
                    case MovementnActionType.police_sent_email_to_haulier:
                        MovementDescription = "Police '" + userInfo.UserName + "' sent email to haulier '" + ObjMovAct.HaulierName + "'." + helpDeskUserstring;
                        break;
                    case MovementnActionType.sort_submit_VR1_appl: //sort desktop submits application
                        MovementDescription = "The VR1 application '" + ObjMovAct.ESDALRef + "' was submitted by SORT user '" + ObjMovAct.ContactName + "'." + helpDeskUserstring;
                        break;
                }
            }
            catch (Exception ex)
