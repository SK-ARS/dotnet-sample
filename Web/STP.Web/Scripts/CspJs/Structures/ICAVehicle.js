    ...
    {
        $("#hideerr").on('click', hideError);
        $("#hideerr").keyup(validateGross);
        $("#PerformBtn").on('click', saveICAData);
        $("#PerformBtn").mouseover(mouseoverIca);
        $("#PerformBtn").mouseout(mouseoutIca);
        $("#btnCancel").on('click', Success);
        $("#btnCancel").mouseover(mouseover);
        $("#btnCancel").mouseout(mouseout);
        $("#PerformB").on('click', saveICADataConfigType );
        $("#PerformB").mouseover(mouseoverIcaone);
        $("#PerformB").mouseout(mouseoutIcaone);
        $("#Cancel").on('click', Success );
        $("#Cancel").mouseover(mouseoverone);
        $("#Cancel").mouseout(mouseoutone);
if($('#hf_Helpdest_redirect').val() ==  "true")
    ...
    $('#MovementClassConfig').change(function () {
        $("#dropError").hide();
    ...
    function performICA() {
        ...
        $("#generalSettingsId").load('../Structures/PerformICAVehicle?structName=' + '@ViewBag.structName' + "&ESRN=" + '@ViewBag.ESRN' + "&objICAVehicleModel=" + '' + "&MovementClassConfig=" + movementClassConfig + "&ConfigType=" + ConfigType + "&CompNum=" + CompNum + "&structureId=" + '@ViewBag.structureId' + "&sectionId=" + '@ViewBag.sectionId' + "&TractorComponentType=" + TractorComponentType + "&TrailerComponentType=" + TrailerComponentType,
                 function () {
                     DisplayResult();
