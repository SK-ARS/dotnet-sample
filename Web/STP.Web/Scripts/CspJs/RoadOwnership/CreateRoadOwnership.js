    ...
    $("#rdoManager,#rdoLA, #rdoHaMac, #rdoPolice").change(function () {
        clearFeilds();
        var id = this.id;
        switch (id) {
            case "rdoManager":
    ...
    $("#local_Authorityname").click(function () {
        $('#validLA').hide();
    });
    $("#ha_Mac_Name").click(function () {
        $('#validHA').hide();
    });
    $("#police_Name").click(function () {
        $('#validPOLICE').hide();
    });
...
if($('#hf_allFeilds').val() ==  'True') {
    ...
    $('#clearLA').click(function () {
        clearLocal_AuthorityName();
    });
    $('#clearHA').click(function () {
        clearHa_Mac_Name();
    });
    $('#clearPolice').click(function () {
        clearPolice_Name();
    });
    $('#saveownerdata').click(function () {
