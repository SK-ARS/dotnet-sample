    ...
    $('#SOSignDateCheck').click(function () {
        if ($('#SOSignDateCheck').is(':checked')) {
            ...
            $('#SOSignFromDate').val('@DateTime.Now.ToString("dd-MMM-yyyy")');
            $('#SOSignToDate').val('@DateTime.Now.ToString("dd-MMM-yyyy")');
        } else {
    ...
    $('#MovDateCheck').click(function () {
        if ($('#MovDateCheck').is(':checked')) {
            ...
            $('#MovFromDate').val('@DateTime.Now.ToString("dd-MMM-yyyy")');
            $('#MovToDate').val('@DateTime.Now.ToString("dd-MMM-yyyy")');
        } else {
    ...
    $('#WorkDueDateCheck').click(function () {
        if ($('#WorkDueDateCheck').is(':checked')) {
            ...
            $('#WorkDueFromDate').val('@DateTime.Now.ToString("dd-MMM-yyyy")');
            $('#WorkDueToDate').val('@DateTime.Now.ToString("dd-MMM-yyyy")');
        } else {
