    $(document).ready(function () {
        ...
        $(".btn_back_to_Config_list").on('click', BackToConfigList);
        $(".ImportOption").on('click', ImportVehicleComponentOption);
        $(".ImportComponentOption").on('click', ImportComponentOption);
    ...
    function ImportVehicleComponent(source) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                //    if ($('#vehicle_Component_edit_section').html().length !=0 ) {
                //        $('#importlist_cntr').html('');
                //        $('#importlist_cntr').html(response);
                //    }
                //    else {
                //        $('#selectComponent').html('');
                //        $('#selectComponent').html(response);
    ...
    function BackToConfigList() {
        window.location.href = "@Url.Action("VehicleConfigList", "VehicleConfig")";
    }
