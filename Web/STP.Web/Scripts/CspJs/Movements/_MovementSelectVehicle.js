    ...
    $(document).ready(function () {
        ...
        $('body').on('click','.btn_createvehicle', function() { window['CreateNewConfiguration'](); });
        $('body').on('click','.btn_fleetlibrary', function() { window['ImportVehicle']('fleet'); });
        $('body').on('click','.btn_prevmovement', function() { window['ImportVehicle']('prevMov'); });
        $('body').on('click','.closeamendmentpopup', function() { window['closeAmendmentPopup'](); });
        $('body').on('click','.btn_choosefromsimilarcombination', function() { window['ChooseFromSimilarCombinations'](); });
