...
if($('#hf_showRestriction').val() ==  'False') {
if($('#hf_hideLayout').val() ==  'True') {
            ...
            $.ajax(
                {
                    ...
                    success: function (data) {
                        ...
                        $('<div id="btncreatedispensation" class="button mr-0"><button class= "btn-outline-primary SOAButtonHelper mb-3 btn-border-remove" role = "button" aria - pressed="true" style="background-color: white;" onclick = "CreateDis()">Create Dispensation</button></div>').insertBefore("#dispensationBody");
    ...
    function CreateDis(f_name) {
        ...
        var Grantor_name  = $('#hf_val() ? $('#hdnGrantor_Org').val() : '@ViewBag.Grantor_name'.replace(/ /g, '%20').val(); 
