    ...
    $(document).ready(function () {
        ...
        $(".getRouteVehicleDetails").on('click', GetRouteVehicleDetails);
    });
    ...
    function GetRouteVehicleDetails(RoutePartId) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#agreedRouteMap").load('@Url.Action("A2BPlanning", "Routes", new { routeID = 0 })', function () {
    ...
    function VehicleDetails(VehicleId) {
        $.ajax({
            type: 'POST',
            url: '../VehicleConfig/ViewConfigurationGeneral?vehicleID=' + VehicleId,// + '&isMovement=false',
            data: {  },
            beforeSend: function (xhr) {
                startAnimation();
            },
