    ...
    {       
        ...
        $('body').on('click', '.ListAffectedRoads', ListAffectedRoads);
        $('body').on('click', '.ListAffectedRoads', ListAnnotation);
        $('body').on('click', '.ListAffectedRoads', ListDrivingInstructions);
...
if($('#hf_IsDIGenerate').val() ==  'True') {
    ...
    function CheckConstraintList() {
        ...
        $.ajax({
            ...
            cache: false,
            async: false,
            data: { routeId: routeId, routeType: routeParams.routeType, BSortFlag: sortFlag },
            beforeSend: function () {
                startAnimation();
            },
    ...
    function ListAffectedRoads(data) {
        var id = data.currentTarget.attributes.id.value;
        var divId = data.currentTarget.attributes.divId.value;
