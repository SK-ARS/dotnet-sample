var hf_Template = $('#hf_Template').val();
var hf_SONumber = $('#hf_SONumber').val();

    $(document).ready(function () {

$('body').on('click','#btnDelete', function(e) { 
  e.preventDefault();
  DeleteSpecialOrder_Click(this);
}); 
$('body').on('click','#btnGenerateDoc', function(e) { 
  e.preventDefault();
  GenrateDoc(this);
}); 
    ...
    function GenrateDoc(){
        var doctype=hf_Template;
        var esdalRef=$('#Concate').val();
        var SOnumber = hf_SONumber;
        var doc="SO"+doctype;
        if(doctype!=""){
