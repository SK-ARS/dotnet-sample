		...
		function selectDates(selected) {
			...
			function makeWeek(week) {
				...
				for (var e = 0; e < 7; e++) {
					...
					// tiru changes
					if (daysArray[e] === 'Sunday') {
						week.append("<div>Su</div>")
					} else if (daysArray[e] === 'Monday') {
						week.append("<div>Mo</div>")

					} else if (daysArray[e] === 'Tuesday') {
						week.append("<div>Tu</div>")

					} else if (daysArray[e] === 'Wednesday') {
						week.append("<div>We</div>")

					} else if (daysArray[e] === 'Thursday') {
						week.append("<div>Th</div>")
					} else if (daysArray[e] === 'Friday') {
						week.append("<div>Fr</div>")
					} else if (daysArray[e] === 'Saturday') {
						week.append("<div>Sa</div>")
