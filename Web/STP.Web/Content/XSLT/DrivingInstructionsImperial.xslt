          ...
          <div id="showDrivingdetails">
            <div class="main-table" style="border-radius: 0px 0px 0px 0px;">
              <table>
                <tbody>
                  <tr>
                    <th width="50%" style="padding-left:10px !important; color: white !important">Route directions</th>
                    <th class="pl-1" style="color: white !important">Cautions</th>
                  </tr>
                </tbody>
              </table>
            </div>
                  ...
                  <div class="details-below" style="cursor: pointer;">
                    <span class="details">
                      <xsl:if test="$recCount>1" >
                        <xsl:if test="($mode='start' and position()=1)" >
                          <b><xsl:value-of select="concat('Alternative ', 'start', ' # ',$AlternativeNo,':')" /></b>
                        </xsl:if>
                        <xsl:if test="$mode='middle' and position()=1 and $recCount>1" >
                            <b><xsl:value-of select="concat('Alternative ', ' # ',$AlternativeNo,':')" /></b>
                        </xsl:if>
                      </xsl:if>
                      ...
                      <xsl:if test="$recCount>1" >
                        <xsl:if test="($mode='end' and position()=last())" >
                          <b><xsl:value-of select="concat('Alternative ', 'end', ' # ',$AlternativeNo,':')" /></b>
                        </xsl:if>
                      </xsl:if>
                    </span>
                    ...
                    <xsl:for-each select="a:NoteListPosition">
                     ...
                     width="15" style="display: block;" class="viewmoredetails" count="{$count}"></img>
                        <img id="chevlon-down-icon1{$count}" class="viewmoredetails" count="{$count}" src="../Content/assets/images/down-chevlon-filter.svg" width="15"
