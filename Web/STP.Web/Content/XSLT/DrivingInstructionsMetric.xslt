          ...
          <div id="showDrivingdetails">
            <div class="main-table" style="border-radius: 25px 0px 0px 0px;">
              <table>
                <tbody>
                  <tr>
                    <th width="50%" style="padding-left:10px !important">Route directions</th>
            ...
            <xsl:for-each select="a:SubPartListPosition/a:SubPart">
              ...
              <xsl:for-each select="a:AlternativeListPosition">
                ...
                <xsl:for-each select="a:Alternative/a:InstructionListPosition/a:Instruction">
                  ...
                  <div class="details-below" style="cursor: pointer;">
                    <span class="details">
                    ...
                    <xsl:for-each select="a:NoteListPosition">
                      ...
                      <xsl:if test="$iterationCount=1" >
                        <img id="chevlon-up-icon1{$count}" src="../Content/assets/images/up-chevlon-filter.svg"
                     width="15" style="display: block;"  class="viewmoredetails" count="{$count}"></img>
                        <img id="chevlon-down-icon1{$count}" src="../Content/assets/images/down-chevlon-filter.svg" width="15"
                         style="display: none;" class="viewmoredetails" count="{$count}"></img>
                      </xsl:if>
						
						<xsl:variable name="CaAnnotationType" select="a:Note/a:Content/a:Annotation/@AnnotationType" />
						

						<xsl:variable name="Caudisplay">
							<xsl:choose>
								<xsl:when test="$CaAnnotationType='special_manouevre'">
                      ...
                      <!--<div id='{$count}' class='{$count}' style="display:{ $Caudisplay};">-->
                      <div id='{$count}' class='{$count}' style="display:block;">
                        <div class="row">
                ...
                <xsl:if test="($mode='start' or $mode='middle')  and $recCount>1 and position() = $recCount" >
                  <div class="details-below">
                        <span class="details"><b>Alternative Routes Merge</b>
                      </span>
                  </div>
                </xsl:if>
              </xsl:for-each>
