    ...
    <html>
      ...
      <body style="font-family:Arial;font-size:13px;">
        ...
        <table width = "100%">
          ...
          <tr>
            ...
            <td colspan="3">
              ...
              <xsl:if test="ns1:Contact/ns1:HAContact/ns3:Contact != ''">
                <div>
                  <trim>
                    <xsl:call-template name="string-trim">
                      <xsl:with-param name="string" select="ns1:Contact/ns1:HAContact/ns3:Contact" />
                    </xsl:call-template>
                  </trim>
                </div>
              </xsl:if>
              ...
              <table style="font-family:Arial">
                ...
                <xsl:if test="ns1:Contact/ns1:HAContact/ns3:EmailAddress != ''">
                  <tr>
                    <td valign="top">
                      Email address:<xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text> <xsl:value-of select="ns1:Contact/ns1:HAContact/ns3:EmailAddress" />
                    </td>
                  </tr>
                </xsl:if>
              </table>
        ...
        <p>
          ...
          <!--<xsl:if test="ns1:EMRN/ns3:Mnemonic != '' and  ns1:EMRN/ns3:MovementProjectNumber!='' and ns1:EMRN/ns3:MovementVersion!='' ">
            <xsl:value-of select="ns1:EMRN/ns3:Mnemonic"/>/<xsl:value-of select="ns1:EMRN/ns3:MovementProjectNumber"/>/S<xsl:value-of select="ns1:EMRN/ns3:MovementVersion"/>
          </xsl:if>-->
          <br/><br/>
