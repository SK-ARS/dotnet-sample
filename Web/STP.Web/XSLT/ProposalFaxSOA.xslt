...
<xsl:stylesheet version="1.0"
        ...
        <xsl:if test="ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:Distance/ns2:Imperial/ns2:Distance != ''">
          ...
          <xsl:if test="$UnitType=692001">
            ...
            <p>
              <b>
                ...
                <!--<xsl:if test="$StatusVehicle = 'false'">
                  Leg: C <xsl:value-of select="ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:Name" /> <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
          ...
          <xsl:if test="$UnitType=692002">
            ...
            <xsl:variable name="var11" select="round(number($var10) div number(1760))"/>
			    <xsl:variable name="var_routeName" select="ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:Name" />
            <p>
              <b>
                VEHICLE DETAILS

                <!--<xsl:if test="$StatusVehicle = 'false'">
                  Leg: D <xsl:value-of select="ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:Name" /> <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
  ...
  <xsl:template name="string-trim">
	...
	<xsl:template name="newline">
		  <xsl:param name="line" select="$newline" />
