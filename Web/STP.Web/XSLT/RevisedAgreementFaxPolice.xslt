      ...
      <body style="font-family:Arial;font-size:13px;">
        ...
        <table  bgcolor="#e9eef4">
          <tr>
            <td style="padding-left:3em;">
              <h2>Provisional amendment to agreed route</h2>
            </td>
          </tr>
          <tr>
            <td style="padding-left:3em">
        ...
        <table style ="left-align;width:100%" >
          <!--<tr>
            <td align ="left" style="width:200px" valign="top">
              <b>
                FACSIMILE MESSAGE - Provisional amendment to agreed route
              </b>
            </td>
          </tr>-->
                    ...
                    <xsl:choose>
                      <xsl:when test="ns2:ESDALReferenceNumber/ns2:Mnemonic != '' and  ns2:ESDALReferenceNumber/ns2:MovementProjectNumber!='' and ns2:ESDALReferenceNumber/ns2:MovementVersion!='' ">
                        <xsl:if test="contains(ns2:JourneyFromTo/ns2:From, '##**##') and contains(ns2:JourneyFromTo/ns2:To, '##**##')">
                          <strike>
                            - <xsl:value-of select="substring-before(ns2:JourneyFromTo/ns2:From, '##**##')"/>
                            <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>to <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                            <xsl:value-of select="substring-before(ns2:JourneyFromTo/ns2:To, '##**##')" />
                          </strike>
                          <b>
                            <u>
        ...
        <p>
          ...
          <tr>
              ...
              <td align ="left" width ="60"  >
                <xsl:call-template name="parseString">
                  <xsl:with-param name="list" select="ns2:HaulierDetails/ns2:EmailAddress"/>
                </xsl:call-template>
              </td>
              <td border ="0">
              </td>
              ...
              <td align ="left">
                <xsl:if test="contains(ns2:SignedOn, '##**##')">
                  <strike>
                    <xsl:element name="newdate">
                      <xsl:call-template name="FormatDate">
                        <xsl:with-param name="DateTime" select="substring-before(ns2:SignedOn, '##**##')"/>
                      </xsl:call-template>
                    </xsl:element>
                  </strike>
                  <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
              ...
              <td align ="left">
                <xsl:if test="contains(ns2:ExpiresOn, '##**##')">
                  <strike>
                    <xsl:element name="newdate">
                      <xsl:call-template name="FormatDate">
                        <xsl:with-param name="DateTime" select="substring-before(ns2:ExpiresOn, '##**##')"/>
                      </xsl:call-template>
                    </xsl:element>
                  </strike>
                  <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
        ...
        <p>
          ...
          <br/>
          <b>Number of pieces moved at one time:</b>
          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                      ...
                      <b>
                        <u>
                          <xsl:if test="$UnitType=692001">
                            ...
                            <xsl:choose>
                              <xsl:when test="contains($var12, ' OR ')">
                                  <xsl:variable name="var10OrBefore" select="substring-before($var12, ' OR ')"/>
                                  <xsl:variable name="var10OrAfter" select="substring-after($var12, ' OR ')"/>                                
                                  <xsl:variable name="var13" select="round(number($var10OrAfter) div number(1000))"/> 
                                  <xsl:variable name="var14" select="round(number($var10OrBefore) div number(1000))"/> 
                                 <xsl:value-of select="$var14"/> <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>km or 
                                 <xsl:value-of select="$var13"/> <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>km
                              </xsl:when>
                              <xsl:otherwise>
                                <xsl:variable name="var13" select="round(number($var12) div number(1000))"/>  
                          ...
                          <xsl:if test="$UnitType=692002">
                            ...
                            <xsl:choose>
                              <xsl:when test="contains($var12, ' OR ')">
                                  <xsl:variable name="var12OrAfter" select="substring-after($var12, ' OR ')"/>
                                  <xsl:variable name="var13" select="round(number($var12OrAfter) div number(1760))"/> 
                                 <xsl:value-of select="$var13"/> <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>miles
                              </xsl:when>
                              <xsl:otherwise>
                                <xsl:variable name="var13" select="round(number($var12) div number(1760))"/>  
        ...
        <xsl:variable name="StatusVehicle">
		  ...
		  <xsl:variable name="NewVehicleName">
        ...
        <xsl:variable name="IsRouteNameChangedArray" select="msxsl:node-set($IsRouteNameChanged)/item" />
		  <xsl:variable name="NewVehicleNameArray" select="msxsl:node-set($NewVehicleName)/item" />
        ...
        <br/>
        <!--Vehicle all details starts here-->
        <xsl:for-each select="ns2:RouteParts/ns2:RoutePartListPosition">

          <xsl:variable name="getOuterPosition" select="position()" />
          <xsl:variable name="Vehicles" select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles" />

          <xsl:for-each select="$Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration">
			  <xsl:variable name="getPosition" select="position()" />
			  <xsl:for-each select="ns3:SemiVehicle">
            ...
            <xsl:if test="ns3:Summary != ''">
              ...
              <b>
                Vehicle : <xsl:choose>
                <xsl:when test="contains($Vehicles/ns3:ConfigurationSummaryListPosition[$getPosition]/ns3:ConfigurationSummary, '##**##')">
                  <xsl:value-of select="substring-after($Vehicles/ns3:ConfigurationSummaryListPosition[$getPosition]/ns3:ConfigurationSummary, '##**##')"/>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:value-of select="$Vehicles/ns3:ConfigurationSummaryListPosition[$getPosition]/ns3:ConfigurationSummary" />
                </xsl:otherwise>
              </xsl:choose>
              </b>
              <br></br>
              ...
              <br/>
				  ...
				  <xsl:for-each select="ns3:NonSemiVehicle">
			  <xsl:if test="(ns3:ComponentListPosition/ns3:Component/ns3:DrawbarTractor/ns3:AxleConfiguration/ns3:AxleWeightListPosition/ns3:AxleWeight != '' and 
                                ns3:ComponentListPosition/ns3:Component/ns3:DrawbarTractor/ns3:AxleConfiguration/ns3:AxleWeightListPosition/ns3:AxleWeight != 0) or      
                                (ns3:ComponentListPosition/ns3:Component/ns3:LoadBearing/ns3:AxleConfiguration/ns3:AxleWeightListPosition/ns3:AxleWeight != '' and
                                ns3:ComponentListPosition/ns3:Component/ns3:LoadBearing/ns3:AxleConfiguration/ns3:AxleWeightListPosition/ns3:AxleWeight != 0)">
            <xsl:if test="$getPosition = 1">
              <xsl:choose>
                <xsl:when test="$IsRouteNameChangedArray[$getOuterPosition] = 'true'">
                  <b>
            ...
            <br></br>
            <br/>
            <xsl:for-each select="ns3:ComponentListPosition">
                                      ...
                                      <xsl:choose>
                                        <xsl:when test="ns6:EncounteredAt/ns6:DisplayMetric != ''">
                                          <xsl:choose>
                                            ...
                                            <xsl:variable name="var1" select="ns6:EncounteredAt/ns6:DisplayMetric" />
                                            <xsl:choose>
                                              <xsl:when test="contains($var1, '##**##')">
                                                  <xsl:variable name="var2" select="substring-after($var1, '##**##')"/>
                                                  <xsl:variable name="var13" select="format-number($var2 div 1000, '#.##')"/> 
                                                 <xsl:value-of select="$var13"/> <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>km
                                              </xsl:when>
                                              <xsl:otherwise>
                                                <xsl:variable name="var13" select="format-number($var1 div 1000, '#.##')"/>  
                                                <xsl:value-of select="$var13"/> <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>km
                                              </xsl:otherwise>
                                            </xsl:choose>
                                            </xsl:otherwise>
