      ...
      <body style="font-family:Arial;font-size:13px;">
       ...
       <div>
        ...
        <table style ="left-align;width:100%" >
          ...
          <tr>
            <td align ="left" sstyle="width:25%" valign="top" >
          ...
          <tr>
            ...
            <td  align ="left" style="width:75%" valign="top" colspan="2">
        ...
        <p>
          <b>
            Approximate date of first movement:<xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
          </b>
