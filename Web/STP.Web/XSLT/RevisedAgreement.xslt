      ...
      <body style="font-family:Arial;font-size:13px;">
        ...
        <p>
          <table style ="left-align;width:100%" >
            <tr>
              <td align ="left" style="width:200px" valign="top">
                <b>Agreed Route </b>for the movement of<xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                <xsl:call-template name="parseString">
                                      ...
                                      <xsl:choose>
                                        <xsl:when test="ns6:EncounteredAt/ns6:DisplayMetric != ''">
                                          <xsl:choose>
                                            <xsl:when test="contains(ns6:EncounteredAt/ns6:DisplayMetric, '##**##')">
                                              <strike>
                                                <xsl:variable name="var12" select="substring-before(ns6:EncounteredAt/ns6:DisplayMetric, '##**##')"/>
                                                <xsl:choose>
                                                  <xsl:when test="$var12 &lt; 1000">
                                                    <xsl:value-of select="$var12"/> m
                                                  </xsl:when>
                                                  <xsl:otherwise>
                                                    <xsl:variable name="var2" select="format-number($var12 div 1000, '#.##')"/>
                                                    <xsl:value-of select="$var2"/><xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>km
                                                  </xsl:otherwise>
                                              </xsl:choose>
                                              </strike>
                                                <b>
                                                  <u>
                                                    <xsl:variable name="varAfter" select="substring-after(ns6:EncounteredAt/ns6:DisplayMetric, '##**##')"/>
                                                    <xsl:choose>
                                                        <xsl:when test="$varAfter &lt; 1000">
                                                          <xsl:value-of select="$varAfter"/> m
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                          <xsl:variable name="var2" select="format-number($varAfter div 1000, '#.##')"/>
                                                          <xsl:value-of select="$var2"/><xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>km
                                                        </xsl:otherwise>
                                                     </xsl:choose>
                                                </u>
                                      ...
                                      <xsl:choose>
                                        <xsl:when test="ns6:EncounteredAt/ns6:DisplayImperial != ''">
                                          <xsl:choose>
                                            <xsl:when test="contains(ns6:EncounteredAt/ns6:DisplayImperial, '##**##')">
                                              <strike>
                                                <xsl:variable name="var12" select="substring-before(ns6:EncounteredAt/ns6:DisplayImperial, '##**##')"/>
                                                <xsl:choose>
                                                  <xsl:when test="$var12 &lt; 1760">
                                                    <xsl:value-of select="$var12"/> yards
                                                  </xsl:when>
                                                  <xsl:otherwise>
                                                    <xsl:variable name="var2" select="format-number($var12 div 1760, '#.##')"/>
                                                    <xsl:value-of select="$var2"/><xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>miles
                                                  </xsl:otherwise>
                                              </xsl:choose>
                                              </strike>
                                                <b>
                                                  <u>
                                                    <xsl:variable name="varAfter" select="substring-after(ns6:EncounteredAt/ns6:DisplayImperial, '##**##')"/>
                                                    <xsl:choose>
                                                        <xsl:when test="$varAfter &lt; 1760">
                                                          <xsl:value-of select="$varAfter"/> yards
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                          <xsl:variable name="var2" select="format-number($varAfter div 1760, '#.##')"/>
                                                          <xsl:value-of select="$var2"/><xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>miles
                                                        </xsl:otherwise>
                                                     </xsl:choose>
                                                </u>
