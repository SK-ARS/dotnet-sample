    ...
    <html>
      <body>
        ...
        <table  bgcolor="#e9eef4">
          ...
          <tr>
            <td style="padding-left:3em;font-style: normal">
              ...
              <span >Classification: <span style="color:#275795">special order</span></span>
              <br />
              <br />
            </td>
          </tr>
        ...
        <xsl:if test="ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:Distance/ns2:Imperial/ns2:Distance != ''">
          <xsl:if test="$UnitType=692001">
            <xsl:variable name="var10" select="ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:Distance/ns2:Metric/ns2:Distance" />
            ...
            <p>
              <b>
                ...
                <!-- <xsl:if test="$StatusVehicle = 'false'">
                  Leg: <xsl:value-of select="ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:Name" /> <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
