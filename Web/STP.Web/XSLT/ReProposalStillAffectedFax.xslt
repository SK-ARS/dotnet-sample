        ...
        <table>
          ...
          <xsl:for-each select="ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart">
            <tr>
              ...
              <td colspan="3">
                <xsl:if test="ns2:RoadPart != ''">
					<xsl:choose>                   
					  <xsl:when test="contains(ns2:RoadPart/ns2:Distance/ns2:Imperial/ns2:Distance, '##**##') or 
								contains(ns2:RoadPart/ns2:Distance/ns2:Metric/ns2:Distance, '##**##')">
					      <xsl:if test="$UnitType=692001">
						      <xsl:if test="contains(ns2:RoadPart/ns2:Distance/ns2:Metric/ns2:Distance, '##**##')">
							      <strike>
					      ...
					      <xsl:if test="$UnitType=692002">
						      <xsl:if test="contains(ns2:RoadPart/ns2:Distance/ns2:Imperial/ns2:Distance, '##**##')">
							      <strike>
