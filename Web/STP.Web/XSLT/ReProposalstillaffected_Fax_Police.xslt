...
<xsl:stylesheet version="1.0"
      ...
      <body style="font-family:Arial;font-size:13px;">
        ...
        <table  bgcolor="#e9eef4" >
          <tr>
            <td style="padding-left:3em;">
              <h2>Amendment to provisional route</h2>       
            </td>
          </tr>
          <tr>
            <td style="padding-left:3em">
        ...
        <table style="left-align;width:100%" cellspacing ="0" cellpadding ="0">
          <!--<tr>
            <td align ="left" valign="top">
              <b>FACSIMILE MESSAGE - Amendment to provisional route</b>
            </td>
          </tr>-->
          <tr>
            <td colspan="16">
            ...
            <tr>
              <td align ="left" style="width:200px" valign="top">
                <b>
                  Route summary for
                  <xsl:call-template name="parseString">
                    <xsl:with-param name="list" select="ns2:JourneyFromToSummary/ns2:From"/>
                  </xsl:call-template>
                  <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>to <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                  <xsl:call-template name="parseString">
                    <xsl:with-param name="list" select="ns2:JourneyFromToSummary/ns2:To"/>
                  </xsl:call-template>
                </b>
              </td>
            </tr>
                    ...
                    <xsl:choose>
                      ...
                      <xsl:otherwise>
                        <xsl:value-of select="ns2:ESDALReferenceNumber/ns2:Mnemonic"/>/S<xsl:value-of select="ns2:ESDALReferenceNumber/ns2:MovementProjectNumber"/>/S<xsl:if test="contains(ns2:ESDALReferenceNumber/ns2:MovementVersion, '##**##')">
                          ...
                          <xsl:value-of select="ns2:ESDALReferenceNumber/ns2:Mnemonic"/>/S<xsl:value-of select="ns2:ESDALReferenceNumber/ns2:MovementProjectNumber"/>/S<xsl:value-of select="ns2:ESDALReferenceNumber/ns2:MovementVersion"/>
                        </xsl:if>
                      </xsl:otherwise>
                    </xsl:choose>
                  </td>
        ...
        <p>
          ...
          <xsl:for-each select="ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart">
            ...
            <xsl:variable name="totalRoutes" select="position()"></xsl:variable>
							  ...
							  <xsl:otherwise>
								  <xsl:choose>
									  <xsl:when test="position() > 1">
										  <xsl:if test="generate-id($configurationSummaryList[. = current()][1])!=generate-id($configurationSummaryList[. = current()-1][1])">
											  <b>
  ...
  <xsl:template name="loop1">
    <xsl:param name="i"/>
    <xsl:param name="inputArray"></xsl:param>
    <xsl:value-of select="inputArray[i]"/>
  </xsl:template>
