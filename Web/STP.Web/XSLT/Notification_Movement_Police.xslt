    ...
    <html>
      ...
      <body style="font-family:Arial">
        ...
        <!--<table width = "100%" cellspacing ="0" cellpadding ="0">
          <tr>
            <td colspan="4">
              <img align="left" width="120" height="80" id="hdr_imgs" src="~/Content/assets/images/logo.png"/>
            </td>
          </tr>
          <tr>
            <td>
        ...
        <table  bgcolor="#e9eef4">
          <tr>
            <td style="padding-left:3em;">
              <h2>Notification – Detailed Version</h2>
            </td>
          </tr>
          <tr>
            <td style="padding-left:3em">
        ...
        <br/>
         ...
         <xsl:if test="ns1:Classification != ''">
          ...
          <xsl:choose>
            <xsl:when test="contains(ns1:Classification, '##**##')">
              <xsl:choose>
                <xsl:when test="substring-after(ns1:Classification, '##**##') = 'Wheeled construction and use'">
                  <p align="center">
            ...
            <xsl:otherwise>
              <xsl:choose>
                <xsl:when test="ns1:Classification = 'Wheeled construction and use'">
                  <p align="center">
                    <b> Form of notice to Police </b>
                  </p>
                  <p align="center">
        ...
        <table style ="margin-left" width="100%" border = "1" align = "left">
          ...
          <tr>
            ...
            <td  width="40%"  valign="top">
              <xsl:variable name="ConfigurationType" select="ns1:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:ConfigurationType" />
              <xsl:for-each select="$ConfigurationType">
                <xsl:if test="generate-id() = generate-id($ConfigurationType[. = current()][1])">
                  <xsl:if test="(last()=2 and position()=2)">
                    <br></br>
                  </xsl:if>
                  <xsl:if test="position() > 1 and position() != last()"> or </xsl:if>
