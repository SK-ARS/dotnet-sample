...
namespace XmlAnalysedCautions
{
    ...
    public partial class AnalysedCautionChoiceStructure
    {
        ...
        public AnalysedCautionConstraintStructure analCautConstrStructObj
        {
            get;
            set;
        }
        ...
        public AnalysedCautionStructureStructure analCautStructStructObj
        {
            get;
            set;
        }
    ...
    public partial class CautionedEntityChoiceStructure
    {
        ...
        public CautionedConstraintStructure cautConstStructObj
        {
            get;
            set;
        }
        ...
        public CautionedStructureStructure cautStructStructObj
        {
            get;
            set;
        }
