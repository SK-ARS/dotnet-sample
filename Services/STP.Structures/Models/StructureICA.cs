...
namespace STP.Structures.Models
{
    ...
    public class StructureICATwo
    {
        public string ICAMethod { get; set; }
        public double BandLimit { get; set; }
        public bool SV_80 { get; set; }
        public bool SV_100 { get; set; }
        public bool SV_150 { get; set; }
        public bool SV_Train { get; set; }
    }

    public class StructureICAThree
    {
        public string ICAMethod { get; set; }
        public double BandLimit { get; set; }
    ...
    public class ManageStructureICA
    {
        ...
        public decimal? EnableSV_80 { get; set; }
        public decimal? EnableSV_100 { get; set; }
        public decimal? EnableSV_150 { get; set; }
        public decimal? EnableSV_Train { get; set; }
