  ...
  <xsl:template match="/ns1:SpecialOrder">
    <html>
      ...
      <body style="font-family:Arial">
        ...
        <p>
          The Secretary of State in exercise of his powers under section 44 of the Road Traffic Act 1988 hereby authorises the use on roads of a heavy motor car being a heavy motor car which has
        ...
        <ol>
            ...
            <table style="font-family:Arial">
              ...
              <tr>
                ...
                <td valign="top" colspan="22" style="padding-left: 10px;">
                  ...
                  <xsl:value-of select="ns1:ViaLocation"/><xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>by such
          ...
          <li>
            ...
            <table style="font-family:Arial">
              ...
              <tr>
                <td colspan="2">of the 2003 Order shall apply to the use of a heavy motor car authorised by this Order as they apply to the use of a heavy motor car authorised by Part 2 and Part 4 articles 28 to 31 and Schedule 1 to that Order.</td>
              </tr>
            </table>
          </li>
          ...
          <li>
            Unless specifically directed in writing by or on behalf of the chief officer of police of every police area through which the journey is to be made the heavy motor car and trailer shall not be used under this Order during any of the following periods:-
          ...
          <li>
            ...
            <table style="font-family:Arial">
              <tr>
                <td width="95%">
                  (a)	an indemnity in the form set out in Part 2 of Schedule 9 to the 2003 Order shall be given by or on behalf of
                  <xsl:value-of select="ns2:HaulierName"/>
          ...
          <li style="margin-bottom:20px">
            Before the heavy motor car crosses any automatic half-barrier railway level crossing or any other railway level crossing, equipped with a telephone, the driver of the towing vehicle shall telephone the railway signaller of the intention to cross the railway with the heavy motor car. The heavy motor car and the vehicles used with it shall not cross except with the permission of and in accordance with the instructions of the railway signaller. After crossing the driver shall again telephone the signaller to inform him that the crossing is clear.
            <P style="padding-bottom:0px;"></P>
          </li>
          <li>
