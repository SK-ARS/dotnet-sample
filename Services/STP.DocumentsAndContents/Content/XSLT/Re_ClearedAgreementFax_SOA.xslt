    ...
    <html>
      <body style="font-family:Arial;font-size:13px;">
        ...
        <p>
          <table style ="left-align;width:100%" >
            <tr>
              <td align ="left" style="width:200px" valign="top">
                <b>
                  Route summary for <xsl:value-of select="ns2:JourneyFromToSummary/ns2:From" /> <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>to <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text> <xsl:value-of select="ns2:JourneyFromToSummary/ns2:To" />
                </b>
        ...
        <xsl:variable name="FirstVehicle">
          ...
          <xsl:for-each select="ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:ConfigurationSummaryListPosition">
            <xsl:if test="ns3:ConfigurationSummary != ''">
              <xsl:if test="position()=1">
                <xsl:choose>
                  <xsl:when test="contains(ns3:ConfigurationSummary, '##**##')">
                    <xsl:value-of select="substring-after(ns3:ConfigurationSummary,'##**##')"/>
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:value-of select="ns3:ConfigurationSummary"/>
                  </xsl:otherwise>
                </xsl:choose>
              </xsl:if>
            </xsl:if>
            ...
            <xsl:if test="ns3:ConfigurationSummary != ''">
              ...
              <xsl:choose>
                <xsl:when test="contains(ns3:ConfigurationSummary, '##**##')">
                  ...
                  <xsl:if test="$FirstVehicle != substring-after(ns3:ConfigurationSummary,'##**##')">
                    <xsl:value-of select="false()"/>
                  </xsl:if>

                </xsl:when>
                <xsl:otherwise>
                  <xsl:if test="$FirstVehicle != ns3:ConfigurationSummary">
                    <xsl:value-of select="false()"/>
                  </xsl:if>
                </xsl:otherwise>
              </xsl:choose>
                ...
                <item>
                  ...
                  <xsl:choose>
                    <xsl:when test="contains(ns2:RoadPart/ns2:Distance/ns2:Metric/ns2:Distance, '##**##')">
                      <xsl:variable name="var10" select="substring-after(ns2:RoadPart/ns2:Distance/ns2:Metric/ns2:Distance, '##**##')"/>
                      <xsl:variable name="var11" select="round(number($var10) div number(1000))"/>
                      <xsl:value-of select="$var11"/><xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>km
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:variable name="var10" select="ns2:RoadPart/ns2:Distance/ns2:Metric/ns2:Distance" />
                      <xsl:variable name="var11" select="round(number($var10) div number(1000))"/>
                      <xsl:value-of select="$var11"/><xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>km
                    </xsl:otherwise>
                  </xsl:choose>
            ...
            <xsl:if test="$UnitType=692002">
              <xsl:if test="$StatusVehicle = 'false'">
                <item>
                  ...
                  <xsl:choose>
                    <xsl:when test="contains(ns2:RoadPart/ns2:Distance/ns2:Metric/ns2:Distance, '##**##')">
                      <xsl:variable name="var10" select="substring-after(ns2:RoadPart/ns2:Distance/ns2:Imperial/ns2:Distance, '##**##')"/>
                    ...
                    <xsl:otherwise>
                      <xsl:variable name="var10" select="ns2:RoadPart/ns2:Distance/ns2:Imperial/ns2:Distance" />
                      <xsl:variable name="var11" select="round(number($var10) div number(1760))"/>
                      <xsl:value-of select="$var11"/><xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>miles
                    </xsl:otherwise>
                  </xsl:choose>
        ...
        <!--For Semi Vehicles Ends here-->
          <xsl:for-each select="ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:SemiVehicle">
            <xsl:variable name="getPosition" select="position()" />
			  <xsl:if test="(ns3:AxleConfiguration/ns3:AxleWeightListPosition/ns3:AxleWeight != '') and 
                      (ns3:AxleConfiguration/ns3:AxleWeightListPosition/ns3:AxleWeight !=0)">
            ...
            <table style ="margin-left" border = "1">
                    ...
                    <xsl:for-each select="ns3:AxleConfiguration/ns3:AxleWeightListPosition">
                      ...
                      <xsl:if test="ns3:AxleWeight!='' and ns3:AxleWeight/@AxleCount!=''">
                        ...
                        <xsl:choose>
                          ...
                          <xsl:otherwise>
                            <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>yard
                          </xsl:otherwise>
                        </xsl:choose>
                        <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text> x<xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text> <xsl:value-of select="ns3:AxleWeight/@AxleCount"/>
                      </xsl:if>
                  ...
                  <td colspan="2">
                    ...
                    <xsl:for-each select="ns3:AxleConfiguration/ns3:WheelsPerAxleListPosition">
                      ...
                      <xsl:if test="ns3:WheelsPerAxle!='' and ns3:WheelsPerAxle/@AxleCount!=''">
                        <xsl:value-of select="ns3:WheelsPerAxle"/><xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text> x<xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text> <xsl:value-of select="ns3:WheelsPerAxle/@AxleCount"/>
                      </xsl:if>
                  ...
                  <td colspan="2">
                    <xsl:for-each select="ns3:AxleConfiguration/ns3:AxleSpacingListPosition">
                      <xsl:if test="ns3:AxleSpacing!='' and ns3:AxleSpacing/@AxleCount!=''">
                        ...
                        <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text> x<xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text> <xsl:value-of select="ns3:AxleSpacing/@AxleCount"/>
                      </xsl:if>
                      <xsl:if test="position() != last()">
                        ,
                      </xsl:if>
                  ...
                  <td colspan="2">
                    <xsl:for-each select="ns3:AxleConfiguration/ns3:TyreSizeListPosition">
                      ...
                      <xsl:if test="ns3:TyreSize!='' and ns3:TyreSize/@AxleCount!=''">
                        <xsl:value-of select="ns3:TyreSize"/><xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text> x<xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text> <xsl:value-of select="ns3:TyreSize/@AxleCount"/>
                      </xsl:if>
                  ...
                  <td colspan="2">
                    <xsl:for-each select="ns3:AxleConfiguration/ns3:WheelSpacingListPosition">
                      ...
                      <xsl:if test="ns3:WheelSpacing!='' and ns3:WheelSpacing/@AxleCount!=''">
                        <xsl:value-of select="ns3:WheelSpacing"/><xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text> x<xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text> <xsl:value-of select="ns3:WheelSpacing/@AxleCount"/>
                      </xsl:if>
              ...
              <xsl:if test="ns3:Height/ns3:MaxHeight!=''">
                <tr>
                  ...
                  <td colspan="2">
                    <xsl:if test="ns3:Height/ns3:MaxHeight != ''">
                      <xsl:value-of select="ns3:Height/ns3:MaxHeight"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
              ...
              <xsl:if test="ns3:Height/ns3:ReducibleHeight!=''">
                <tr>
                  ...
                  <td colspan="2">
                    <xsl:if test="ns3:Height/ns3:ReducibleHeight != ''">
                      <xsl:value-of select="ns3:Height/ns3:ReducibleHeight"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
                ...
                <td colspan="2">
                  <xsl:choose>
                    <xsl:when test="ns3:Wheelbase != ''">
                      <xsl:value-of select="ns3:Wheelbase"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
                ...
                <td colspan="2">
                  <xsl:choose>
                    <xsl:when test="ns3:LeftOverhang != ''">
                      <xsl:value-of select="ns3:LeftOverhang"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
                ...
                <td colspan="2">
                  <xsl:choose>
                    <xsl:when test="ns3:RightOverhang != ''">
                      <xsl:value-of select="ns3:RightOverhang"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
                ...
                <td colspan="2">
                  <xsl:choose>
                    <xsl:when test="ns3:FrontOverhang != ''">
                      <xsl:value-of select="ns3:FrontOverhang"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
                ...
                <td colspan="2">
                  <xsl:choose>
                    <xsl:when test="ns3:RearOverhang != ''">
                      <xsl:value-of select="ns3:RearOverhang"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
                ...
                <td colspan="2">
                  <xsl:choose>
                    <xsl:when test="ns3:GroundClearance != ''">
                      <xsl:value-of select="ns3:GroundClearance"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
                ...
                <td colspan="2">
                  <xsl:choose>
                    <xsl:when test="ns3:ReducedGroundClearance != ''">
                      <xsl:value-of select="ns3:ReducedGroundClearance"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
                ...
                <td colspan="2">
                  <xsl:choose>
                    <xsl:when test="ns3:OutsideTrack != ''">
                      <xsl:value-of select="ns3:OutsideTrack"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
        ...
        <!--For Non Semi Vehicles-->
          ...
          <xsl:for-each select="ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:NonSemiVehicle/ns3:ComponentListPosition">
            <xsl:variable name="getPosition" select="position()" />
			  <xsl:if test="(ns3:Component/ns3:DrawbarTractor/ns3:AxleConfiguration/ns3:AxleWeightListPosition/ns3:AxleWeight != '' and 
                                ns3:Component/ns3:DrawbarTractor/ns3:AxleConfiguration/ns3:AxleWeightListPosition/ns3:AxleWeight != 0) or      
                                (ns3:Component/ns3:LoadBearing/ns3:AxleConfiguration/ns3:AxleWeightListPosition/ns3:AxleWeight != '' and
                                ns3:Component/ns3:LoadBearing/ns3:AxleConfiguration/ns3:AxleWeightListPosition/ns3:AxleWeight != 0)">
            <xsl:if test="$getPosition &gt; 1">
              <b>
                <xsl:value-of select="$VehiclesArray[$getPosition]"/>
              </b>
            ...
            <table style ="margin-left" border = "1">
              <tr>
                ...
                <td colspan="2">
                  <b>
                    ...
                    <xsl:if test="ns3:Component/ns3:LoadBearing/ns3:Summary!='' ">
              ...
              <xsl:if test="ns3:Component/ns3:DrawbarTractor/ns3:Weight!=''">
                <tr>
                  ...
                  <td colspan="2">
                    <xsl:if test="ns3:Component/ns3:DrawbarTractor/ns3:Weight!=''">
                      <xsl:value-of select="ns3:Component/ns3:DrawbarTractor/ns3:Weight"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>kg
                        </xsl:when>
              ...
              <xsl:if test="ns3:Component/ns3:LoadBearing/ns3:Weight!=''">
                <tr>
                  ...
                  <td colspan="2">
                    <xsl:if test="ns3:Component/ns3:LoadBearing/ns3:Weight!=''">
                      <xsl:value-of select="ns3:Component/ns3:LoadBearing/ns3:Weight"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>kg
                        </xsl:when>
              ...
              <xsl:if test="ns3:Component/ns3:LoadBearing/ns3:RigidLength != ''">
                <tr>
                  ...
                  <td colspan="2">
                    <xsl:if test="ns3:Component/ns3:LoadBearing/ns3:RigidLength != ''">
                      <xsl:value-of select="ns3:Component/ns3:LoadBearing/ns3:RigidLength"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
              ...
              <xsl:if test="ns3:Component/ns3:DrawbarTractor/ns3:Length != ''">
                <tr>
                  ...
                  <td colspan="2">
                    <xsl:if test="ns3:Component/ns3:DrawbarTractor/ns3:Length != ''">
                      <xsl:value-of select="ns3:Component/ns3:DrawbarTractor/ns3:Length"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
              ...
              <xsl:if test="ns3:Component/ns3:LoadBearing/ns3:Width!=''">
                <tr>
                  ...
                  <td colspan="2">
                    <xsl:if test="ns3:Component/ns3:LoadBearing/ns3:Width != ''">
                      <xsl:value-of select="ns3:Component/ns3:LoadBearing/ns3:Width"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
              ...
              <xsl:if test="ns3:Component/ns3:LoadBearing/ns3:Height/ns3:MaxHeight!=''">
                <tr>
                  ...
                  <td colspan="2">
                    <xsl:if test="ns3:Component/ns3:LoadBearing/ns3:Height/ns3:MaxHeight != ''">
                      <xsl:value-of select="ns3:Component/ns3:LoadBearing/ns3:Height/ns3:MaxHeight"/>
                      <xsl:choose>
                        <xsl:when test="$UnitType=692001">
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                        </xsl:when>
                  ...
                  <td colspan="2">
                    <xsl:choose>
                      <xsl:when test="ns3:Component/ns3:LoadBearing/ns3:RightOverhang != ''">
                        <xsl:value-of select="ns3:Component/ns3:LoadBearing/ns3:RightOverhang"/>
                        <xsl:choose>
                          <xsl:when test="$UnitType=692001">
                            <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                          </xsl:when>
                  ...
                  <td colspan="2">
                    <xsl:choose>
                      <xsl:when test="ns3:Component/ns3:LoadBearing/ns3:FrontOverhang != ''">
                        <xsl:value-of select="ns3:Component/ns3:LoadBearing/ns3:FrontOverhang"/>
                        <xsl:choose>
                          <xsl:when test="$UnitType=692001">
                            <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                          </xsl:when>
                  ...
                  <td colspan="2">
                    <xsl:choose>
                      <xsl:when test="ns3:Component/ns3:LoadBearing/ns3:RearOverhang != ''">
                        <xsl:value-of select="ns3:Component/ns3:LoadBearing/ns3:RearOverhang"/>
                        <xsl:choose>
                          <xsl:when test="$UnitType=692001">
                            <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                          </xsl:when>
                  ...
                  <td colspan="2">
                    <xsl:choose>
                      <xsl:when test="ns3:Component/ns3:LoadBearing/ns3:GroundClearance != ''">
                        <xsl:value-of select="ns3:Component/ns3:LoadBearing/ns3:GroundClearance"/>
                        <xsl:choose>
                          <xsl:when test="$UnitType=692001">
                            <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                          </xsl:when>
                  ...
                  <td colspan="2">
                    <xsl:choose>
                      <xsl:when test="ns3:Component/ns3:LoadBearing/ns3:OutsideTrack != ''">
                        <xsl:value-of select="ns3:Component/ns3:LoadBearing/ns3:OutsideTrack"/>
                        <xsl:choose>
                          <xsl:when test="$UnitType=692001">
                            <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                          </xsl:when>
