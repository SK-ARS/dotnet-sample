...
xmlns:ns5="http://www.esdal.com/schemas/core/route"
    ...
    <html>
      ...
      <body style="font-family:Arial;font-size:10.5px;">
        ...
        <table border = "1" width = "100%">
          ...
          <tr>
            <td align="center" valign="top">
              <xsl:if test="contains(ns1:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:StartPointListPosition/ns2:StartPoint/ns5:Description, '##**##')">
                <xsl:value-of select="substring-after(ns1:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:StartPointListPosition/ns2:StartPoint/ns5:Description, '##**##')"/>
              </xsl:if>

              <xsl:if test="contains(ns1:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:StartPointListPosition/ns2:StartPoint/ns5:Description, '##**##')=false()">
            ...
            <td align="center" valign="top">
              <xsl:if test="contains(ns1:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:EndPointListPosition/ns2:EndPoint/ns5:Description, '##**##')">
                <xsl:value-of select="substring-after(ns1:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:EndPointListPosition/ns2:EndPoint/ns5:Description, '##**##')"/>
              </xsl:if>

              <xsl:if test="contains(ns1:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:EndPointListPosition/ns2:EndPoint/ns5:Description, '##**##')=false()">
        ...
        <xsl:for-each select="ns1:RouteParts/ns2:RoutePartListPosition">
            ...
            <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:OverallLengthListPosition">
              <xsl:if test="ns3:OverallLength/ns3:IncludingProjections !=''">
                <xsl:call-template name="parseStringForMeters">
                  <xsl:with-param name="list" select="ns3:OverallLength/ns3:IncludingProjections"/>
                </xsl:call-template>
              </xsl:if>
            </xsl:for-each>
          </xsl:variable>
          ...
          <xsl:variable name="OverallWidthListPositionString">
            <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:OverallWidthListPosition">
              <xsl:if test="ns3:OverallWidth !=''">
                <xsl:call-template name="parseStringForMeters">
                  <xsl:with-param name="list" select="ns3:OverallWidth"/>
                </xsl:call-template>
              </xsl:if>
            </xsl:for-each>
          </xsl:variable>
          ...
          <xsl:variable name="OverallHeightListPositionString">
            <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:OverallHeightListPosition">
              <xsl:if test="ns3:OverallHeight/ns3:MaxHeight !=''">
                <xsl:call-template name="parseStringForMeters">
                  <xsl:with-param name="list" select="ns3:OverallHeight/ns3:MaxHeight"/>
                </xsl:call-template>
              </xsl:if>
            </xsl:for-each>
          </xsl:variable>
          ...
          <xsl:variable name="OverallHeightListPositionReducibleHeightString">
            ...
            <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:OverallHeightListPosition">
              <xsl:if test="ns3:OverallHeight/ns3:ReducibleHeight !=''">
                <xsl:call-template name="parseStringForMeters">
                  <xsl:with-param name="list" select="ns3:OverallHeight/ns3:ReducibleHeight"/>
                </xsl:call-template>
              </xsl:if>
            </xsl:for-each>
              ...
              <table border = "1" width = "100%">
                ...
                <tr>
                  ...
                  <td valign="top">
                    <!--TODO Right-->
                    <xsl:choose>
                      <xsl:when test="substring-after($RightOverhangListPositionString,'or ') !='' and substring-after($RightOverhangListPositionString,'or ') !='0 m '">
          ...
          <xsl:if test="$ClassificationCategory != ''">
            <!--For Semi Vehicles-->
              <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition">
				  <xsl:if test="(ns3:VehicleSummary/ns3:Configuration/ns3:SemiVehicle/ns3:AxleConfiguration/ns3:NumberOfAxles != '') and (ns3:VehicleSummary/ns3:Configuration/ns3:SemiVehicle/ns3:AxleConfiguration/ns3:NumberOfAxles !=0)">
            ...
            <!--For Non Semi Vehicles-->
              <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:NonSemiVehicle/ns3:ComponentListPosition">
				  <xsl:if test="$ClassificationCategory != ''">				  					  
					  <xsl:if test="(ns3:Component/ns3:DrawbarTractor/ns3:AxleConfiguration/ns3:NumberOfAxles != 0) or
						   (ns3:Component/ns3:LoadBearing/ns3:AxleConfiguration/ns3:NumberOfAxles != 0)">
					    <xsl:if test="(ns3:Component/ns3:DrawbarTractor/ns3:Summary != '') or (ns3:Component/ns3:LoadBearing/ns3:Summary != '') ">
						  <table border = "0" width = "100%">
							  <tr>
								  <td  valign="top">
									  <b>
						  ...
						  <tr>
							  ...
							  <td colspan="2" width="75%" valign="top">
								  <xsl:choose>
									  ...
									  <xsl:when test="contains(ns3:Component/ns3:DrawbarTractor/ns3:Weight, '##**##')">
          ...
          <!--<xsl:if test="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:TrackedVehicle/ns3:Summary != ''">
			...
			<xsl:if test="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:Configuration/ns3:TrackedVehicle/ns3:GrossWeight/ns3:Weight != ''">
				<table border = "1" width = "100%">
              <tr>
                <td width="25%" valign="top">
                  <b>Gross weight (kg) </b>
                ...
                <td colspan="2" width="75%" valign="top">
                  <xsl:choose>
                    ...
                    <xsl:when test="contains(ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:Configuration/ns3:TrackedVehicle/ns3:GrossWeight/ns3:Weight, '##**##')">
                      <xsl:if test="substring-after(ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:Configuration/ns3:TrackedVehicle/ns3:GrossWeight/ns3:Weight, '##**##') != ''">
                        <xsl:value-of select="substring-after(ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:Configuration/ns3:TrackedVehicle/ns3:GrossWeight/ns3:Weight, '##**##')"/>
                        <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>kg
                      </xsl:if>
                    </xsl:when>

                    <xsl:when test="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:Configuration/ns3:TrackedVehicle/ns3:GrossWeight/ns3:Weight != ''">
                      <xsl:value-of select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:Configuration/ns3:TrackedVehicle/ns3:GrossWeight/ns3:Weight"/>
                      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>kg
                    </xsl:when>
        ...
        <!-- Code changes needs to be modified over here TODO-->
        <br></br>
        <xsl:if test="ns1:Recipients/ns2:Contact/ns2:ContactName!=''">
          <table border = "1" width = "100%">
            <tr>
              <td>
                <p align="center">
        ...
        <xsl:if test="ns1:Classification = 'Wheeled construction and use'">
          <table  border = "1" width = "100%">
            <tr>
              <td>
                <p>
                  All axle weights and spacing within C and U or AWR limits.
                </p>
              </td>
            </tr>
          </table>
          ...
          <table border = "0" >
            ...
            <tr>
              ...
              <td colspan="63">
                ...
                </xsl:if> starting with the date on which the indemnity was signed.
              </td>
            </tr>
            <tr>
              <td colspan="65" >
        ...
        <table  border = "0" width = "100%">
          <tr>
            <td>
              <p>
                <b>
                  PLEASE ACKNOWLEDGE RECEIPT OF THIS EMAIL. Acknowledgement will confirm to the sender that you
                  have received and read the email.
                </b>
  ...
  <xsl:template name="parseStringForMeters">
    ...
    <xsl:if test="contains($list, '##**##')">
      <xsl:if test="$UnitType='' or $UnitType=692001">
        or <xsl:value-of select="substring-after($list, '##**##')"/>
