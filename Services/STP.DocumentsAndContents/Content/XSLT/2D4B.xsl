  ...
  <xsl:template match="/ns1:SpecialOrder">
    <html>
      ...
      <body style="font-family:Arial">
        ...
        <ol start="1">
          <li style="margin-bottom:5px;margin-right:3.5em !important;">
          ...
          <li style="margin-bottom:20px">
            Every load bearing tyre shall be designed and manufactured to support the maximum permitted axle weight for the speed at which the trailer is drawn.
            <P style="padding-bottom:0px;"></P>
          </li>
