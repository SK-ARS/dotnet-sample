    ...
    <html>
      <body style="font-family:Arial;font-size:13px;">
        ...
        <table>
          <!--<tr>
            <td valign="top">1.</td>
            <td colspan="30">The National Highways (HA) has been requested to supply a route for the above mentioned movement(s).</td>
          </tr>-->
          <tr>
            <td valign="top">1.</td>
            <td colspan="30">
        ...
        <table>
          <tr>
            <td>
              <b>
                ROUTE OVERVIEW <br/>
                Number of movements: <xsl:if test="contains(ns2:LoadDetails/ns2:TotalMoves, '##**##')">
                ...
                Number of pieces moved at one time: <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
