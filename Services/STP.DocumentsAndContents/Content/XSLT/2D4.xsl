  ...
  <xsl:template match="/ns1:SpecialOrder">
    <html>
      ...
      <body style="font-family:Arial">
        ...
        <p>
          The Secretary of State in exercise of his powers under section 44 of the Road Traffic Act 1988 hereby authorises the use on roads of a trailer  which is so constructed as to be capable of carrying an abnormal indivisible load (within the meaning of article 3 of the Road Vehicles (Authorisation of Special Types) (General) Order 2003 (" the 2003 Order") being a

           <xsl:if test="ns1:Load!=''">
        ...
        <ol>
            ...
            <table style="font-family:Arial">
              <tr>
                ...
                <td valign="top" colspan="22">
                  ...
                  if it is the trailer

                    <xsl:if test="ns1:VehiclesSchedule/ns1:Vehicle/ns1:Summary != ''">
              ...
              <tr>
                ...
                <td valign="top" colspan="22">
                  for the purpose of
                  <xsl:value-of select="ns1:NoOfJourneysInWord"/>
                  <xsl:choose>
          ...
          <li style="margin-bottom:20px">
            ...
            <table style="font-family:Arial">
              ...
              <tr>
                <td valign="top">(2)</td>
                <td colspan="24">
                  Schedule 1 Part 3 of the 2003 Order shall apply to the use of a trailer authorised by this Order as it applies to the use of a vehicle in Category 3 authorised by Part 2 and Part 4 articles 28 to 31 and Schedule 1 to that Order.
                </td>
              </tr>
            </table>
          </li>
          <li style="margin-bottom:20px">
            The trailer and its load shall not travel on any road at a speed exceeding 12 miles per hour.
          </li>
          <li style="margin-bottom:20px">
            Notwithstanding article 3, the trailer and its load may travel at a speed not exceeding 20mph on motorways and dual carriageway roads provided:
            <table style="font-family:Arial">
              <tr>
                <td valign="top" align="right">
                  (a)
                ...
                <td valign="top" colspan="22">
                  the trailer and its load does not exceed the load/speed restrictions specified on any plate required by article 2(2) of this Order; and
                </td>
              </tr>
              <tr>
                <td valign="top" align="right">
                ...
                <td valign="top" colspan="22">
                  the trailer is equipped with a braking system that complies with the construction, fitting and performance requirements set out in Schedule 1, Part 2, paragraphs 8 to 12 of the 2003 Order as they apply to a vehicle falling within Category 3.
                </td>
              </tr>
            </table>
          ...
          <li style="margin-bottom:20px">
            Every load bearing tyre shall be designed and manufactured to support the maximum permitted weight of the axle for the speed at which the trailer is drawn.
          </li>
          ...
          <li style="margin-bottom:20px">
            The trailer shall be equipped with an efficient braking system; the braking system shall not be rendered ineffective by the non-rotation of the engine of the drawing vehicle; the brakes of a trailer shall come into operation automatically on its overrun or the driver of, or some other person on, the drawing vehicle or on the trailer shall be able to apply the brakes on the trailer; the brakes of the trailer shall apply in the case of a wheeled vehicle to at least 2 wheels if the vehicle has no more than 4 wheels and to at least half the wheels if the vehicle has more than 4 wheels; and the parking brake shall be capable of being set so as effectively to prevent at least two of the wheels from revolving when the trailer is not being drawn. The requirements of this article do not apply to a trailer authorised to travel at a speed exceeding 12 miles per hour by article 4 of this Order and is equipped with a braking system meeting the requirements of article 4(b).
          </li>
          <li style="margin-bottom:20px">
          ...
          <li style="margin-bottom:20px">
            Unless specifically directed in writing by on behalf of the chief officer of police of every police area through which the journey is to be made, the trailer shall not be used under this Order during any of the following periods:-
        ...
        <p>
          <xsl:choose>
            <xsl:when test="count(ns1:VehiclesSchedule/ns1:Vehicle) &gt;= 2">
              The weights shown in this Schedule are the safe gross loads only in so far as the route capacity is concerned. Owing to varying loading conditions these weights do not purport to represent the safe capacity of these trailers. It is the hauliers' responsibility to check with the trailer manufacturer that the load and its method of loading is within the safe structural and mechanical limits specified by the manufacturer.
            </xsl:when>
            <xsl:otherwise>
              The weight shown in this Schedule is the safe gross load only in so far as the route capacity is concerned. Owing to varying loading conditions this weight does not purport to represent the safe capacity of this trailer. It is the hauliers' responsibility to check with the trailer manufacturer that the load and its method of loading is within the safe structural and mechanical limits specified by the manufacturer.
            </xsl:otherwise>
          </xsl:choose>
        </p>
      </body>
