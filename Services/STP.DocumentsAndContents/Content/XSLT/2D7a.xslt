  ...
  <xsl:template match="/ns1:SpecialOrder">
    <html>
      ...
      <body style="font-family:Arial">
        <b><p style="font-color:red">2D7 (A)
            </p>
        </b>
        <p>
          <b>
        ...
        <ol>
            ...
            <table style="font-family:Arial">
              <tr>
                ...
                <td valign="top" colspan="22" style="padding-left: 10px;">
                  if it is the heavy motor car and trailer
          ...
          <li style="margin-bottom:20px">
            The heavy motor car and trailer and its load shall not exceed the load/speed restrictions specified on any plate required by article 2 (2) of this Order
           <P style="padding-bottom:0px;"></P>
          </li>
          <li style="margin-bottom:20px">
          ...
          <li style="margin-bottom:20px">
            Every load bearing tyre shall be designed and manufactured to support the maximum permitted weight of the axle for the speed at which the combination is drawn.
            <P style="padding-bottom:0px;"></P>
          </li>
