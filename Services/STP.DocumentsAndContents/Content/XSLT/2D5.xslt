  ...
  <xsl:template match="/ns1:SpecialOrder">
    <html>
      ...
      <body style="font-family:Arial">
        ...
        <p>
          The Secretary of State in exercise of his powers under section 44 of the Road Traffic Act 1988 hereby authorises the use on roads of a heavy motor car and trailer being a heavy motor car and trailer which has
        ...
        <ol>
            ...
            <table style="font-family:Arial">
              ...
              <tr>
                ...
                <td valign="top" colspan="22" style="padding-left: 10px;">
                  ...
                  <xsl:if test="ns1:ViaLocation !=''">
                  via<xsl:value-of select="ns1:ViaLocation"/></xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>by such
              ...
              <tr>
                ...
                <td colspan="24" style="padding-left: 10px;">
                  ...
                  <table style="font-family:Arial">
                      ...
                      <td width="85%">
                        <xsl:choose>
                          <xsl:when test="ns1:Width &gt;6.1">
                            (a)<xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;&nbsp;]]></xsl:text>Schedule 1 - paragraph 5-15, 17(2), 20, 25, 26 - 37;
                          </xsl:when>
                          ...
                          <xsl:otherwise>
                            (a)<xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;&nbsp;]]></xsl:text>Schedule 1 - paragraph 5-15, 17(2), 20, 24, 25, 26 - 37;
                          </xsl:otherwise>
                        </xsl:choose>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td>of the 2003 Order shall apply to the use of a heavy motor car and trailer authorised by this Order as they apply to the use of a heavy motor car and trailer authorised by Part 2 and Part 4 articles 28 to 31 and Schedule 1 to that Order.</td>
                    </tr>
                  </table>
                </td>
              </tr >
          ...
          <li style="margin-bottom:20px">
            Before the heavy motor car and trailer crosses any automatic half-barrier railway level crossing or any other railway level crossing, equipped with a telephone, the driver of the towing vehicle shall telephone the railway signaller of the intention to cross the railway with the heavy motor car and trailer. The heavy motor car and trailer and the vehicles used with it shall not cross except with the permission of and in accordance with the instructions of the railway signaller. After crossing the driver shall again telephone the signaller to inform him that the crossing is clear.
            <P style="padding-bottom:0px;"></P>
          </li>
          <li style="margin-bottom:20px">
          ...
          <li style="margin-bottom:20px">
            ...
            <br/>
            Ref:          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
            <xsl:value-of select="ns2:JobFileReferenceNumber"/>
           </li>
        </ol>
      </body>
    </html>
