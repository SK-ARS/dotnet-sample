  ...
  <xsl:template match="/ns1:SpecialOrder">
    <html>
      ...
      <body style="font-family:Arial">
        ...
        <p>
          The Secretary of State in exercise of his powers under section 44 of the Road Traffic Act 1988 hereby authorises the use on roads of a trailer
          ...
          <xsl:value-of select="ns1:Load"/> [MODULE]
        ...
        <ol>
                ...
                <td valign="top" colspan="22" style="padding-left: 10px;">
                  ...
                  <xsl:choose>
                   ...
                   (each of) which shall take place before the
                    <xsl:value-of select="ns1:CustomFormatExpiryDate"/>
                </td>
              </tr>
              <tr>
          ...
          <li style="margin-bottom:20px">
            The trailer and its load shall not exceed the load/speed restrictions specified on any plate required by article 2(2) of this Order.
            <P style="padding-bottom:0px;"></P>
          </li>
          <li style="margin-bottom:20px">
