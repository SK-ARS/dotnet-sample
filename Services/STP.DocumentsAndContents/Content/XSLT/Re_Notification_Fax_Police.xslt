...
<xsl:stylesheet version="2.0"
      ...
      <body style="font-family:Arial">
        ...
        <table border = "1" width = "100%">
          <tr>
            <td align="left" valign="top">
              MOVEMENT PROGRAMME:
              <xsl:call-template name="parseStringByNewLine">
            ...
            <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:OverallLengthListPosition">
              <xsl:choose>
                <xsl:when test="contains(ns3:OverallLength/ns3:IncludingProjections,'##**##')">
                  <xsl:if test="substring-before(ns3:OverallLength/ns3:IncludingProjections,'##**##') !=''">

                    <xsl:if test="$UnitType='' or $UnitType=692001">
                      or <xsl:value-of select="substring-before(ns3:OverallLength/ns3:IncludingProjections,'##**##')"/>
                      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m**##**
                    </xsl:if>

                    <xsl:if test="$UnitType=692002">
                      <xsl:call-template name="ConvertToFeetPart">
                        <xsl:with-param name="pText" select="substring-before(ns3:OverallLength/ns3:IncludingProjections,'##**##')"></xsl:with-param>
                      </xsl:call-template>
                    </xsl:if>
                ...
                <xsl:otherwise>
                  <xsl:if test="ns3:OverallLength/ns3:IncludingProjections !=''">
                    ...
                    <xsl:if test="$UnitType=692002">
                      <xsl:call-template name="ConvertToFeetWithOR">
            ...
            <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:FrontOverhangListPosition">
              <xsl:choose>
                <xsl:when test="contains(ns3:FrontOverhang,'##**##')">
                  <xsl:if test="substring-before(ns3:FrontOverhang,'##**##') !=''">

                    <xsl:if test="$UnitType='' or $UnitType=692001">
                      or <xsl:value-of select="substring-before(ns3:FrontOverhang,'##**##')"/>
                      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m**##**
                    </xsl:if>

                    <xsl:if test="$UnitType=692002">
                      <xsl:call-template name="ConvertToFeetPart">
                        <xsl:with-param name="pText" select="substring-before(ns3:FrontOverhang,'##**##')"></xsl:with-param>
                      </xsl:call-template>
                    </xsl:if>
            ...
            <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:RearOverhangListPosition">
              <xsl:choose>
                <xsl:when test="contains(ns3:RearOverhang,'##**##')">
                  <xsl:if test="substring-before(ns3:RearOverhang,'##**##') !=''">

                    <xsl:if test="$UnitType='' or $UnitType=692001">
                      or <xsl:value-of select="substring-before(ns3:RearOverhang,'##**##')"/>
                      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m**##**
                    </xsl:if>

                    <xsl:if test="$UnitType=692002">
                      <xsl:call-template name="ConvertToFeetPart">
                        <xsl:with-param name="pText" select="substring-before(ns3:RearOverhang,'##**##')"></xsl:with-param>
                      </xsl:call-template>
                    </xsl:if>
            ...
            <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:LeftOverhangListPosition">
              <xsl:choose>
                <xsl:when test="contains(ns3:LeftOverhang,'##**##')">
                  <xsl:if test="substring-before(ns3:LeftOverhang,'##**##') !=''">

                    <xsl:if test="$UnitType='' or $UnitType=692001">
                      or <xsl:value-of select="substring-before(ns3:LeftOverhang,'##**##')"/>
                      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m**##**
                    </xsl:if>

                    <xsl:if test="$UnitType=692002">
                      <xsl:call-template name="ConvertToFeetPart">
                        <xsl:with-param name="pText" select="substring-before(ns3:LeftOverhang,'##**##')"></xsl:with-param>
                      </xsl:call-template>
                    </xsl:if>
                  ...
                  <xsl:if test="substring-after(ns3:LeftOverhang,'##**##') !=''">
                    ...
                    <xsl:if test="$UnitType='' or $UnitType=692001">
                      <xsl:value-of select="substring-after(ns3:LeftOverhang,'##**##')"/>
                      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                    </xsl:if>
            ...
            <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:RightOverhangListPosition">
              <xsl:choose>
                <xsl:when test="contains(ns3:RightOverhang,'##**##')">
                  <xsl:if test="substring-before(ns3:RightOverhang,'##**##') !=''">

                    <xsl:if test="$UnitType='' or $UnitType=692001">
                      or <xsl:value-of select="substring-before(ns3:RightOverhang,'##**##')"/>
                      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m**##**
                    </xsl:if>

                    <xsl:if test="$UnitType=692002">
                      <xsl:call-template name="ConvertToFeetPart">
                        <xsl:with-param name="pText" select="substring-before(ns3:RightOverhang,'##**##')"></xsl:with-param>
                      </xsl:call-template>
                    </xsl:if>
                  ...
                  <xsl:if test="substring-after(ns3:RightOverhang,'##**##') !=''">
                    ...
                    <xsl:if test="$UnitType='' or $UnitType=692001">
                      <xsl:value-of select="substring-after(ns3:RightOverhang,'##**##')"/>
                      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m
                    </xsl:if>
            ...
            <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:RigidLengthListPosition">
              <xsl:choose>
                <xsl:when test="contains(ns3:RigidLength,'##**##')">
                  <xsl:if test="substring-before(ns3:RigidLength,'##**##') !=''">

                    <xsl:if test="$UnitType='' or $UnitType=692001">
                      or <xsl:value-of select="substring-before(ns3:RigidLength,'##**##')"/>
                      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m**##**
                    </xsl:if>

                    <xsl:if test="$UnitType=692002">
                      <xsl:call-template name="ConvertToFeetPart">
                        <xsl:with-param name="pText" select="substring-before(ns3:RigidLength,'##**##')"></xsl:with-param>
                      </xsl:call-template>
                    </xsl:if>
            ...
            <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:OverallWidthListPosition">
              <xsl:choose>
                <xsl:when test="contains(ns3:OverallWidth,'##**##')">
                  <xsl:if test="substring-before(ns3:OverallWidth,'##**##') !=''">

                    <xsl:if test="$UnitType='' or $UnitType=692001">
                      or <xsl:value-of select="substring-before(ns3:OverallWidth,'##**##')"/>
                      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m**##**
                    </xsl:if>

                    <xsl:if test="$UnitType=692002">
                      <xsl:call-template name="ConvertToFeetPart">
                        <xsl:with-param name="pText" select="substring-before(ns3:OverallWidth,'##**##')"></xsl:with-param>
                      </xsl:call-template>
                    </xsl:if>
            ...
            <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:OverallHeightListPosition">
              <xsl:choose>
                <xsl:when test="contains(ns3:OverallHeight/ns3:MaxHeight,'##**##')">
                  <xsl:if test="substring-before(ns3:OverallHeight/ns3:MaxHeight,'##**##') !=''">

                    <xsl:if test="$UnitType='' or $UnitType=692001">
                      or  <xsl:value-of select="substring-before(ns3:OverallHeight/ns3:MaxHeight,'##**##')"/>
                      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m**##**
                    </xsl:if>

                    <xsl:if test="$UnitType=692002">
                      <xsl:call-template name="ConvertToFeetPart">
                        <xsl:with-param name="pText" select="substring-before(ns3:OverallHeight/ns3:MaxHeight,'##**##')"></xsl:with-param>
                      </xsl:call-template>
                    </xsl:if>
            ...
            <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:OverallHeightListPosition">
              <xsl:choose>
                <xsl:when test="contains(ns3:OverallHeight/ns3:ReducibleHeight,'##**##')">
                  <xsl:if test="substring-before(ns3:OverallHeight/ns3:ReducibleHeight,'##**##') !=''">

                    <xsl:if test="$UnitType='' or $UnitType=692001">
                      or <xsl:value-of select="substring-before(ns3:OverallHeight/ns3:ReducibleHeight,'##**##')"/>
                      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>m**##**
                    </xsl:if>

                    <xsl:if test="$UnitType=692002">
                      <xsl:call-template name="ConvertToFeetPart">
                        <xsl:with-param name="pText" select="substring-before(ns3:OverallHeight/ns3:ReducibleHeight,'##**##')"></xsl:with-param>
                      </xsl:call-template>
                    </xsl:if>
              ...
              <table border = "1" width = "100%">
                ...
                <tr>
                  <td valign="top">
                    ...
                    <xsl:if test="substring-after($IncludingProjectionsString,'or ') =''">-</xsl:if>
                  </td>
                  <td valign="top">
                    <!--TODO 2-->
                    ...
                    <xsl:if test="substring-after($FrontOverhangListPositionString,'or ') =''">-</xsl:if>
                    <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                  </td>
                  <td valign="top">
                    <!--TODO 3-->
                    ...
                    <xsl:if test="substring-after($RearOverhangListPositionString,'or ') =''">-</xsl:if>
                    <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                  </td>
                  <td valign="top">
                    <!--TODO Left-->
                    <xsl:if test="substring-after($LeftOverhangListPositionString,'or ') !=''">
                      <xsl:choose>
                        <xsl:when test="contains(substring-after($LeftOverhangListPositionString,'or '), '**##**')">
                          <xsl:value-of select="substring-after(substring-after($LeftOverhangListPositionString,'or '),' **##**')"/>
                          <strike>
                            <xsl:value-of select="substring-before(substring-after($LeftOverhangListPositionString,'or '),'**##**')"/>
                          </strike>
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                          <u>
                            <b>
                    ...
                    <xsl:if test="substring-after($LeftOverhangListPositionString,'or ') =''">-</xsl:if>
                    <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                  </td>
                  <td valign="top">
                    <!--TODO Right-->
                    <xsl:if test="substring-after($RightOverhangListPositionString,'or ') !=''">
                      <xsl:choose>
                        <xsl:when test="contains(substring-after($RightOverhangListPositionString,'or '), '**##**')">
                          <xsl:value-of select="substring-after(substring-after($RightOverhangListPositionString,'or '),' **##**')"/>
                          <strike>
                            <xsl:value-of select="substring-before(substring-after($RightOverhangListPositionString,'or '),'**##**')"/>
                          </strike>
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                          <u>
                            <b>
                    ...
                    <xsl:if test="substring-after($RightOverhangListPositionString,'or ')=''">-</xsl:if>
                    <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                  </td>
                  <td valign="top">
                    <!--TODO 4-->
                    ...
                    <xsl:if test="substring-after($RigidLengthListPositionString,'or ') =''">-</xsl:if>
                    <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                  </td>
                  <td  valign="top">
                    <!--TODO 5-->
                    ...
                    <xsl:if test="substring-after($OverallWidthListPositionString,'or ')=''">-</xsl:if>
                    <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                  </td>
                  <td  valign="top">
                    <!--TODO 6-->
                    ...
                    <xsl:if test="substring-after($OverallHeightListPositionString,'or ')=''">-</xsl:if>
                    <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                  </td>
                  <td valign="top">
                    <!--TODO 7-->
                    ...
                    <xsl:if test="substring-after($OverallHeightListPositionReducibleHeightString,'or ')=''">-</xsl:if>
                    <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                  </td>
                  <td  valign="top">
                    <!--TODO 8-->
          ...
          <xsl:if test="$ClassificationCategory != ''">
            <!--For Semi Vehicles-->
              <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition">
				  <xsl:if test="(ns3:VehicleSummary/ns3:Configuration/ns3:SemiVehicle/ns3:AxleConfiguration/ns3:NumberOfAxles != '') and 
                                (ns3:VehicleSummary/ns3:Configuration/ns3:SemiVehicle/ns3:AxleConfiguration/ns3:NumberOfAxles !=0)">
            ...
            <!--For Non Semi Vehicles-->
              <xsl:for-each select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:NonSemiVehicle/ns3:ComponentListPosition">
				  <xsl:if test="(ns3:Component/ns3:DrawbarTractor/ns3:AxleConfiguration/ns3:NumberOfAxles != '' and 
                                ns3:Component/ns3:DrawbarTractor/ns3:AxleConfiguration/ns3:NumberOfAxles != 0) or      
                                (ns3:Component/ns3:LoadBearing/ns3:AxleConfiguration/ns3:NumberOfAxles != '' and
                                ns3:Component/ns3:LoadBearing/ns3:AxleConfiguration/ns3:NumberOfAxles != 0)">
            ...
            <table border = "0" width = "100%">
              <tr>
                <td  valign="top">
                  <b>
                    <xsl:choose>
                      <xsl:when test="contains(ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:TrackedVehicle/ns3:Summary,'##**##')">
                        <xsl:value-of select="substring-after(ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:TrackedVehicle/ns3:Summary,'##**##')"/>
                      </xsl:when>

                      <xsl:when test="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:TrackedVehicle/ns3:Summary != ''">
                        <xsl:value-of select="ns2:RoutePart/ns2:RoadPart/ns2:Vehicles/ns3:VehicleSummaryListPosition/ns3:VehicleSummary/ns3:Configuration/ns3:TrackedVehicle/ns3:Summary"/>
                      </xsl:when>
  ...
  <xsl:template name="parseStringByNewLine">
    <xsl:param name="list"/>
    <xsl:if test="contains($list, '##**##')">
      <strike>
        <xsl:call-template name="newLineBySeperator">
          <xsl:with-param name="text" select="substring-before($list, '##**##')"/>
        </xsl:call-template>
        <!--<xsl:value-of select="substring-before($list, '##**##')"/>-->
      </strike>
      <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
      <b>
        <u>
          <xsl:call-template name="newLineBySeperator">
            <xsl:with-param name="text" select="substring-after($list, '##**##')"/>
          </xsl:call-template>
          <!--<xsl:value-of select="substring-after($list, '##**##')"/>-->
        </u>
      </b>
  ...
  <xsl:template match="text()" name="ConvertToFeetPart">
    <xsl:param name="pText" select="."/>
    <!--<xsl:if test="string-length($pText) > 0">-->
  ...
  <xsl:template match="text()" name="ConvertToFeetWithOR">
    <xsl:param name="pText" select="."/>
    <!--<xsl:if test="string-length($pText) > 0">-->
