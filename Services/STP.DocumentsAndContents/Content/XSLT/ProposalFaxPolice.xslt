    ...
    <html>
      <body>
        ...
        <p style="margin-left:20px;">
          <!--1. The National Highways (HE) has been requested to supply a route for the above mentioned movement(s).<br/>-->
          ...
          Esdal2 on-line collaboration facility or by email. <br/>
        ...
        <p>
          ...
          (b) When crossing motorway bridges, vehicles must travel in the left hand lane, unless otherwise stated in specific route cautions.<br/>
