  ...
  <xsl:template match="/ns1:SpecialOrder">
    <html>
      ...
      <body style="font-family:Arial">
        ...
        <p>
          The Secretary of State in exercise of his powers under section 44 of the Road Traffic Act 1988 hereby authorises the use on roads of a heavy motor car 
          ...
          cannot be carried on roads under that Order, notwithstanding that such a heavy motor car does not comply in all respects with the requirements of the Road Vehicles (Construction and Use) Regulations 1986 ("the 1986 Regulations") subject to conditions and restrictions as follows -

        </p>
        <ol>
          <li style="margin-bottom:15px">
            A heavy motor car shall be used under this Order only -
            <table style="font-family:Arial">
              <tr>
                <td valign="top" align="right">(a)</td>
                <td valign="top" colspan="22" style="padding-left: 10px;">
                  if it is the heavy motor car described in the Schedule to this Order;
                </td>
              </tr>
              <tr>
                ...
                <td valign="top" colspan="22" style="padding-left: 10px;">
                  ...
                  <xsl:choose>
                    <xsl:when test="count(ns1:VehiclesSchedule/ns1:Vehicle) &gt;= 2">
                      those heavy motor cars 
                    </xsl:when>
                    <xsl:otherwise>
                      that heavy motor car 
                    </xsl:otherwise>
                  </xsl:choose>
          ...
          <li style="margin-bottom:20px">
            ...
            <table style="font-family:Arial">
              <tr>
                ...
                <td colspan="24" style="padding-left: 10px;">
                  <table style="font-family:Arial">
                    ...
                    <tr>
                      <td>of the 2003 Order shall apply to the use of a heavy motor car authorised by this Order as they apply to the use of a heavy motor car authorised by Part 2 and Part 4 articles 28 to 31 and Schedule 1 to that Order.</td>
                    </tr>
              ...
              <tr>
                <td valign="top">(2)</td>
                <td colspan="24" style="padding-left: 10px;">
                Schedule 1 Part 3 of the 2003 Order shall apply to the use of a heavy motor car authorised by this Order as it applies to the use of a vehicle in Category 3 authorised by Part 2 and Part 4 articles 28 to 31 and Schedule 1 to that Order.
                </td>
              </tr>
            </table>
            <P style="padding-bottom:0px;"></P>
          ...
          <li style="margin-bottom:20px">
            The heavy motor car and its load shall not travel on any road at a speed exceeding 12 miles per hour.
            <P style="padding-bottom:0px;"></P>
          </li>
          <li style="margin-bottom:20px">
            The heavy motor car and its load shall not exceed the load/speed restrictions specified on any plate required by article 2 (2) of this Order
           <P style="padding-bottom:0px;"></P>
          </li>
          <li style="margin-bottom:20px">
          ...
          <li style="margin-bottom:20px">
            Every load bearing tyre shall be designed and manufactured to support the maximum permitted weight of the axle for the speed at which the heavy motor car is drawn.
            <P style="padding-bottom:0px;"></P>
          </li>
          <xsl:if test="ns1:RigidLength &gt;30.0">
            <li style="margin-bottom:20px">
              The overall length of the heavy motor car and its load shall not exceed
          ...
          <xsl:if test="ns1:Width &gt;5.0">
            <li style="margin-bottom:20px">
              The overall width of the heavy motor car and its load shall not exceed
              ...
              <li style="margin-bottom:20px">
            The heavy motor car shall be equipped with a braking system as required by Regulation 16 (4) of the 1986 Regulations
            <P style="padding-bottom:0px;"></P>
          </li>
          <li style="margin-bottom:0px">
            Unless specifically directed in writing by on behalf of the chief officer of police of every police area through which the journey is to be made, the heavy motor car shall not be used under this Order during any of the following periods:-
              <P style="padding-bottom:0px;"></P>
          ...
          <li style="margin-bottom:20px">
            Before the heavy motor car is used under the terms of this Order:
            <table style="font-family:Arial">
              <tr>
                <td valign="top">(a)</td>
                <td colspan="24" style="padding-left: 10px;">
                  ...
                  <xsl:value-of select="ns1:HaulierName"/>
                  to every road authority and every bridge authority responsible for the maintenance and repair of any road or bridge over which it is proposed that the heavy motor car shall pass; and
                </td>
              </tr>
              <tr>
                <td valign="top">(b)</td>
                <td colspan="24" style="padding-left: 10px;">
                  on each occasion before the heavy motor car is used under the terms of this Order notice of the intended use shall be given to each such authority in accordance with Part 1 of Schedule 9 to the 2003 Order and to the chief officer of police of every police area through which the journey is to be made in accordance with Schedule 5 to the 2003 Order except that in every case five clear days notice shall be given.
                </td>
              </tr>
            </table>
            <P style="padding-bottom:0px;"></P>
          ...
          <li style="margin-bottom:20px">
          	Before the heavy motor car crosses any automatic half-barrier railway level crossing or any other railway level crossing, equipped with a telephone, the driver of the heavy motor car shall telephone the railway signaller of the intention to cross the railway with the heavy motor car. The heavy motor car and the vehicles used with it shall not cross except with the permission of and in accordance with the instructions of the railway signaller. After crossing the driver shall again telephone the signaller to inform him that the crossing is clear.
            <P style="padding-bottom:0px;"></P>

          </li>
          <li style="margin-bottom:20px">
            The overall height of the heavy motor car inclusive of its load or of any motor vehicle used in combination with the heavy motor car travelling under any overhead cable or wire shall in no circumstances exceed the headroom specified on any traffic sign or notice relating to such cable or wire except with the prior approval of the owner of the cable or wire.
            <P style="padding-bottom:0px;"></P>

          </li>
          <li style="margin-bottom:15px">
            (1)  Subject to the provisions of paragraph (2) below, where the heavy motor car (or any vehicles used in combination with it) is caused to stop for any reason while it is on a bridge, it shall, as soon as practical, be moved clear of the bridge by appropriate action, without applying any concentrated load to the surface of the part of the road carried by the bridge.
            <table style="font-family:Arial">
              <tr>
                <td valign="top">(2)</td>
                <td colspan="24">
          ...
          <li style="margin-bottom:15px">
            A copy of the Special Order must be carried in the cab of the heavy motor car each time the heavy motor car is used under the terms of the Order.<br></br>
            <P style="padding-bottom:0px;"></P>
        ...
        <p>
          ...
          <p>
            ...
            <xsl:value-of select="ns1:VehiclesSchedule/ns1:Vehicle/ns1:GrossWeight"/>
            kg.
          </p>
          <p>
            <xsl:choose>
              <xsl:when test="count(ns1:VehiclesSchedule/ns1:Vehicle) &gt;= 2">
                The weights shown in this Schedule are the safe gross loads only in so far as the route capacity is concerned. Owing to varying loading conditions these weights do not purport to represent the safe capacity of these heavy motor cars. It is the hauliers' responsibility to check with the heavy motor car manufacturer that the load and its method of loading is within the safe structural and mechanical limits specified by the manufacturer.
              </xsl:when>
              <xsl:otherwise>
                The weight shown in this Schedule is the safe gross load only in so far as the route capacity is concerned. Owing to varying loading conditions this weight does not purport to represent the safe capacity of this heavy motor car. It is the hauliers' responsibility to check with the heavy motor car manufacturer that the load and its method of loading is within the safe structural and mechanical limits specified by the manufacturer.
              </xsl:otherwise>
            </xsl:choose>
          </p>
             <br/>
