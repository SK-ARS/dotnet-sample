            ...
            try
            {
                switch (ObjMovAct.SystemEventType)
                {
                    ...
                    case SysEventType.haulier_deleted_fleet_component:
                        //Sys_Events_Descp = "Haulier deleted fleet component " + ObjMovAct.FleetComponentName + " with id : " + ObjMovAct.FleetComponentId + helpDeskUserstring;
                    ...
                    case SysEventType.allocate_sort_users://allocate_sort_users
                        Sys_Events_Descp = "SORTApplication/AllocateSORTUser with ProjectId: " + ObjMovAct.ProjectId + ", ESDALRef: " + ObjMovAct.ESDALRef + ",Allocate_UserId: " + ObjMovAct.AllocateUser + ",ProjectOwner: " + ObjMovAct.UserName + ",VR1App: " + ObjMovAct.VR1App + helpDeskUserstring;
                        break;
