    ...
    <html>
      <body style="font-family:Arial;font-size:13px;">
        ...
        <table border = "1"  style ="left-align"  >
          ...
          <tr>
            <td align ="left">
              <xsl:value-of select="ns1:OrderSummary/ns1:Signed/ns2:OrderSummary/ns2:CurrentOrder/ns2:OrderNumber"/>
            </td>
            <td align ="left">
              <xsl:element name="newdate">
                <xsl:call-template name="FormatDate">
                  <xsl:with-param name="DateTime" select="ns1:OrderSummary/ns1:Signed/ns2:OrderSummary/ns2:CurrentOrder/ns2:SignedOn"/>
                </xsl:call-template>
              </xsl:element>
            </td>
            <td align ="left">
              <xsl:element name="newdate">
                <xsl:call-template name="FormatDate">
                  <xsl:with-param name="DateTime" select="ns1:OrderSummary/ns1:Signed/ns2:OrderSummary/ns2:CurrentOrder/ns2:ExpiresOn"/>
                </xsl:call-template>
              </xsl:element>
            </td>
          </tr>
        ...
        <p>
          <b>
            ROUTE OVERVIEW <br/>Number of movements:
          </b>
          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
