...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/ns1:AgreedRoute">
    ...
    <html>
        <head>
        <!--
        <link href="http://localhost:65378//Content/Style/Common/bootstrap.min.css" rel="stylesheet" />
        <link href="http://localhost:65378//Content/Style/Common/googleFont.css" rel="stylesheet" />
        <link href="http://localhost:65378//Content/Style/Common/SOAReports.css" rel="stylesheet"    type="text/css"/>
    ...
    <style>
      ...
      <body style="font-family:Arial;font-size:13px;background-color:white">
       ...
       <table width = "100%" cellspacing ="0" cellpadding ="0" class="notes-highlight1">
            <tr>
        ...
        <br></br>
          ...
          <div class="notes-highlight1">
            <span class="text-head">Agreed route</span>
            <br></br>
       ...
       <br/>
          ...
          <table style ="left-align;width:100%" >
            <tr>
              <td align ="left" style="width:200px" valign="top">
                <b>
                  Route summary : 
                  <img src="~Content/Images/pin.png" width="15" alt="vehicle-2"/>
                    ...
                    <xsl:choose>
                      ...
                      <xsl:otherwise>
                        <xsl:if test="contains(ns2:JourneyFromTo/ns2:From, '##**##') and contains(ns2:JourneyFromTo/ns2:To, '##**##')">
                           ...
                           <img src="~Content/Images/pin.png" width="15" alt="vehicle-2"/>
                          <xsl:value-of select="substring-after(ns2:JourneyFromTo/ns2:From, '##**##')"/>
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>to 
                          <img src="~Content/Images/pin.png" width="15" alt="vehicle-2"/>
                          <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                          <xsl:value-of select="substring-after(ns2:JourneyFromTo/ns2:To, '##**##')" />
        ...
        <br/>
        <table border = "0"  style ="left-align" width="90%" cellpadding="5" cellspacing="5">
          ...
          <xsl:for-each select="ns1:OrderSummary/ns1:Signed/ns2:OrderSummary/ns2:CurrentOrder">
            ...
            <tr>
              <td align ="left" class="wd6 text-normal">
 ...
 <tr>
        ...
        <p>
          <xsl:for-each select="ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart">
            ...
            <table border ="0"  width="400" class="row" cellpadding="5"  cellspacing="5">
              <tr>
                <th>
                  <div class="wd4 pl-3 text-highlight">Road</div>
                </th>
                <th>
                  <div class="wd4 pl-3 text-highlight">Distance</div>
                </th>
              </tr>
              <tr>
            ...
            <p>
              <b>
                ...
                <xsl:if test="$StatusVehicle = 'false'">
                  Leg:
                  <xsl:choose>
                    <xsl:when test="contains(ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:Name, '##**##')">
                  ...
                  <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                  <xsl:choose>
                    <xsl:when test="contains(ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:Distance/ns2:Metric/ns2:Distance, '##**##')">
                      <xsl:variable name="var10" select="substring-after(ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:Distance/ns2:Metric/ns2:Distance, '##**##')"/>
              ...
              <b>
                ...
                <xsl:choose>
                  <xsl:when test="contains(ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:Distance/ns2:Imperial/ns2:Distance, '##**##')">
                    <xsl:variable name="var10" select="substring-after(ns2:RouteParts/ns2:RoutePartListPosition/ns2:RoutePart/ns2:RoadPart/ns2:Distance/ns2:Imperial/ns2:Distance, '##**##')"/>
...
<tr>
        ...
        <xsl:choose>
          <xsl:when test="$DocType = 'PDF'">
            ...
            <br/>
            <b>
              Structures you are responsible for have been affected. Details of these structures can be found in ESDAL<Sup>2</Sup>.
            </b>
          </xsl:when>
          <xsl:otherwise>
