...
{
    public static class ProposalDAO
    {
        ...
        /// <returns></returns>
        public static ProposalStructure GetProposalRouteDetails(string esDAlRefNo, int organisationID, int contactId, string userSchema = UserSchema.Portal)
        {
            ...
            if (esdalRefPro.Length > 0)
            {
                ...
                esDAlRefNo = Convert.ToString(esdalRefPro[1].ToUpper().Replace("S", ""));
            ...
            SafeProcedure.DBProvider.Oracle.ExecuteAndHydrateInstance(
                ps,
                userSchema + ".GET_PROPOSAL_DETAILS",
                parameter =>
                {
                   ...
                   (records, instance) =>
                   {
                       ...
                       erns.Mnemonic = haulierMnemonic;
                       erns.MovementProjectNumber = esDAlRefNo;
                       ...
                       instance.SentDateTime = sentDateTime==null || sentDateTime==DateTime.MinValue?DateTime.Now: sentDateTime;//DateTime.Now;
                           ...
                           instance.HAContact = GetHAContactDetails(haulierMnemonic, esDAlRefNo, versionNo, organisationID, userSchema);
                           #endregion
                       ...
                       prrpssplp.StartPoint = GetSimplifiedRoutePointStart(haulierMnemonic, esDAlRefNo, versionNo, organisationID, userSchema);
                       ...
                       prrpseplp.EndPoint = GetSimplifiedRoutePointEnd(haulierMnemonic, esDAlRefNo, versionNo, organisationID, userSchema);
                       ...
                       instance.LoadDetails = lds;
                           ...
                           instance.RouteParts = GetRouteParts(haulierMnemonic, esDAlRefNo, versionNo, organisationID, userSchema);
        ...
        /// <summary>
        /// get route part node detail for proposal document
        /// </summary>
        ...
        /// <param name="userSchema">user schema</param>
        /// <returns></returns>
        public static RoutePartsStructureRoutePartListPosition[] GetRouteParts(string haulierMnemonic, string esDAlRefNo, int versionNo, int organisationID, string userSchema = UserSchema.Portal)
        {
            string messg = "ProposalDAO/GetRouteParts?haulierMnemonic=" + haulierMnemonic + ", esDAlRefNo=" + esDAlRefNo + ", versionNo=" + versionNo + ", organisationID=" + organisationID + ", userSchema=" + userSchema;
            ...
            SafeProcedure.DBProvider.Oracle.ExecuteAndHydrateInstanceList(
               allOutBoundDoc,
               userSchema + ".GET_MULTI_VEHICLE_PROPOSAL",
               parameter =>
               {
                   parameter.AddWithValue("p_HAULIER_MNEMONIC", haulierMnemonic, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
                   parameter.AddWithValue("p_ESDAL_REF_NUMBER", esDAlRefNo, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
            ...
            RoutePartsStructureRoutePartListPosition rpsrplp = new RoutePartsStructureRoutePartListPosition();
            SafeProcedure.DBProvider.Oracle.ExecuteAndHydrateInstanceList(
                rpsrplpList,
                userSchema + ".GET_PROPOSAL_VEHICLE_DETAILS",
                parameter =>
                {
                    parameter.AddWithValue("p_HAULIER_MNEMONIC", haulierMnemonic, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
                    parameter.AddWithValue("p_ESDAL_REF_NUMBER", esDAlRefNo, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
                   ...
                   (records, instance) =>
                   {
                       ...
                       prrpssplp.StartPoint = GetSimplifiedRoutePointStart(haulierMnemonic, esDAlRefNo, versionNo, organisationID, userSchema, routepartid);
                       ...
                       PlannedRoadRoutePartStructureEndPointListPosition prrpseplp = new PlannedRoadRoutePartStructureEndPointListPosition();
                       prrpseplp.EndPoint = GetSimplifiedRoutePointEnd(haulierMnemonic, esDAlRefNo, versionNo, organisationID, userSchema, routepartid);
                       ...
                       if (outBoundDocVar.Count > 0)
                       {
                           ...
                           foreach (var outbound in outBoundDocVar)
                           {
                                       ...
                                       || outbound.VehicleType.ToLower() == "crane" || outbound.VehicleType.ToLower() == "mobile crane")
                               {
                                   ...
                                   {
                                       //stss.TractorSubType = CommonMethods.GetVehicleComponentType(outbound.ComponentType);
                                   ...
                                   List<VehComponentAxles> vehicleComponentAxlesList = GetVehicleComponentAxles(haulierMnemonic, esDAlRefNo, versionNo, outbound.VehicleId, userSchema);
                                       ...
                                       || outbound.VehicleType.ToLower() == "other in line" || outbound.VehicleType.ToLower() == "recovery vehicle" || outbound.VehicleType.ToLower() == "rigid and drag")
                               {
                                   ...
                                   foreach (var vehicleList in vehicleConfigurationList)
                                   {
                                           ...
                                           || nsclpObject.Component.ComponentType == ProposedRouteXSD.VehicleComponentType.rigidvehicle)
                                       {
                                           ...
                                           dtss.Summary = vehicleList.VehicleDescription;
                                           dtss.Weight = Convert.ToString(vehicleList.GrossWeight);
                                           dtss.IsSteerableAtRear = vehicleList.IsSteerableAtRear == 1 ? true : false;
                           ...
                           StructuresModel struInfo = GetStructuresDetail(haulierMnemonic, esDAlRefNo, versionNo, organisationID, userSchema);
                           ...
                           if (affectedPartiesArray != null)
                           {
                               ...
                               ProposedRouteXSD.StructureSectionSuitabilityStructure structureSection = new ProposedRouteXSD.StructureSectionSuitabilityStructure();
                               ...
                               ProposedRouteXSD.SuitabilityResultStructure resultStructure = new ProposedRouteXSD.SuitabilityResultStructure();
                           ...
                           DrivingInstructionModel DrivingInstructionInfo = GetDrivingInstructionStructures(haulierMnemonic, esDAlRefNo, versionNo, organisationID, userSchema);
                           ...
                           #region Roads
                           if (DrivingInstructionInfo != null && DrivingInstructionInfo.DrivingInstructions != null)
                           {
        ...
        /// <summary>
        /// get vehicle component details
        /// </summary>
        /// <param name="haulierMnemonic">haulier mnemonic</param>
        /// <param name="esDAlRefNo">esdal ref no</param>
        /// <param name="versionNo">version no</param>
        /// <param name="vehicleId">organisation id</param>
        /// <param name="userSchema">user schema</param>
        /// <returns></returns>
        public static List<VehComponentAxles> GetVehicleComponentAxles(string haulierMnemonic, string esDAlRefNo, int versionNo, long vehicleId, string userSchema = UserSchema.Portal)
        {
            string messg = "ProposalDAO/GetVehicleComponentAxles?haulierMnemonic=" + haulierMnemonic + ", esDAlRefNo=" + esDAlRefNo + ", versionNo=" + versionNo + ", vehicleId=" + vehicleId + ", userSchema=" + userSchema;
            Logger.GetInstance().LogMessage(Log_Priority.INFORMATIONAL, string.Format(messg + "; Method started successfully"));
            ...
            SafeProcedure.DBProvider.Oracle.ExecuteAndHydrateInstanceList(
                componentAxleList,
                  userSchema + ".GET_PROPOSAL_AXLE_CONFIG",
                parameter =>
                {
                    parameter.AddWithValue("p_HAULIER_MNEMONIC", haulierMnemonic, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
                    parameter.AddWithValue("p_ESDAL_REF_NUMBER", esDAlRefNo, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
        ...
        /// <summary>
        /// get journey start date for proposal document
        /// </summary>
        /// <param name="haulierMnemonic">haulier mnemonic</param>
        /// <param name="esDAlRefNo">esdal ref no</param>
        /// <param name="versionNo">version no</param>
        ...
        /// <param name="userSchema">user schema</param>
        /// <returns></returns>
        public static ProposedRouteXSD.SimplifiedRoutePointStructure GetSimplifiedRoutePointStart(string haulierMnemonic, string esDAlRefNo, int versionNo, int organisationID, string userSchema = UserSchema.Portal, long routePartId = 0)
        {
            string messg = "ProposalDAO/GetSimplifiedRoutePointStart?haulierMnemonic=" + haulierMnemonic + ", esDAlRefNo=" + esDAlRefNo + ", versionNo=" + versionNo + ", organisationID=" + organisationID + ", userSchema=" + userSchema + ", routePartId=" + routePartId;
            Logger.GetInstance().LogMessage(Log_Priority.INFORMATIONAL, string.Format(messg + "; Method started successfully"));
            ...
            SafeProcedure.DBProvider.Oracle.ExecuteAndHydrateInstance(
                srps,
                userSchema + ".GET_PROPOSAL_STARTPOINT",
                parameter =>
                {
                    parameter.AddWithValue("p_HAULIER_MNEMONIC", haulierMnemonic, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
                    parameter.AddWithValue("p_ESDAL_REF_NUMBER", esDAlRefNo, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
        ...
        /// <summary>
        /// get journey end date for proposal document
        /// </summary>
        /// <param name="haulierMnemonic">haulier mnemonic</param>
        /// <param name="esDAlRefNo">esdal ref no</param>
        /// <param name="versionNo">version no</param>
        ...
        /// <param name="userSchema">user schema</param>
        /// <returns></returns>
        public static ProposedRouteXSD.SimplifiedRoutePointStructure GetSimplifiedRoutePointEnd(string haulierMnemonic, string esDAlRefNo, int versionNo, int organisationID, string userSchema = UserSchema.Portal, long routePartId = 0)
        {
            string messg = "ProposalDAO/GetSimplifiedRoutePointEnd?haulierMnemonic=" + haulierMnemonic + ", esDAlRefNo=" + esDAlRefNo + ", versionNo=" + versionNo + ", organisationID=" + organisationID + ", userSchema=" + userSchema + ", routePartId=" + routePartId;
            Logger.GetInstance().LogMessage(Log_Priority.INFORMATIONAL, string.Format(messg + "; Method started successfully"));
            ...
            SafeProcedure.DBProvider.Oracle.ExecuteAndHydrateInstance(
                srps,
                userSchema + ".GET_PROPOSAL_ENDPOINT",
                parameter =>
                {
                    parameter.AddWithValue("p_HAULIER_MNEMONIC", haulierMnemonic, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
                    parameter.AddWithValue("p_ESDAL_REF_NUMBER", esDAlRefNo, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
        ...
        /// <summary>
        /// get hacontact detail for proposal document
        /// </summary>
        /// <param name="haulierMnemonic">haulier mnemonic</param>
        /// <param name="esDAlRefNo">esdal ref no</param>
        /// <param name="versionNo">version no</param>
        ...
        /// <param name="userSchema">user schema</param>
        /// <returns></returns>
        public static HAContactStructure GetHAContactDetails(string haulierMnemonic, string esDAlRefNo, int versionNo, int organisationID, string userSchema = UserSchema.Portal)
        {
            HAContactStructure hacs = new HAContactStructure();

            SafeProcedure.DBProvider.Oracle.ExecuteAndHydrateInstance(
                hacs,
                userSchema + ".GET_PROPOSAL_HACONTACT_DETAILS",
                parameter =>
                {
                    parameter.AddWithValue("p_HAULIER_MNEMONIC", haulierMnemonic, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
                    parameter.AddWithValue("p_ESDAL_REF_NUMBER", esDAlRefNo, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
        ...
        /// <param name="organisationID">organisation id</param>
        /// <returns></returns>
        public static StructuresModel GetStructuresDetail(string haulierMnemonic, string esDAlRefNo, int versionNo, int organisationID, string userSchema = UserSchema.Portal)
        {
            string messg = "ProposalDAO/GetStructuresDetail?haulierMnemonic=" + haulierMnemonic + ", esDAlRefNo=" + esDAlRefNo + ", versionNo=" + versionNo + ", organisationID=" + organisationID + ", userSchema=" + userSchema;
            Logger.GetInstance().LogMessage(Log_Priority.INFORMATIONAL, string.Format(messg + "; Method started successfully"));
            ...
            SafeProcedure.DBProvider.Oracle.ExecuteAndHydrateInstance(
                structuresDetail,
                userSchema + ".GET_PROPOSAL_DRIVINGINST_DTL",
                parameter =>
                {
                    parameter.AddWithValue("p_HAULIER_MNEMONIC", haulierMnemonic, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
                    parameter.AddWithValue("p_ESDAL_REF_NUMBER", esDAlRefNo, OracleDbType.Varchar2, ParameterDirectionWrap.Input, 32767);
        ...
        /// <returns></returns>
        public static ProposedRouteXSD.AffectedStructureStructure1 GetAffectedStructures(int struSectionId)
        {
        ...
        /// <param name="userSchema">user schema</param>
        /// <returns></returns>
        public static DrivingInstructionModel GetDrivingInstructionStructures(string haulierMnemonic, string esDAlRefNo, int versionNo, int organisationID, string userSchema = UserSchema.Portal)
        {
            string messg = "ProposalDAO/GetProposedRouteXSD.DrivingInstructionStructures?haulierMnemonic=" + haulierMnemonic + ", esDAlRefNo=" + esDAlRefNo + ", organisationID=" + organisationID + ", userSchema=" + userSchema;
            Logger.GetInstance().LogMessage(Log_Priority.INFORMATIONAL, string.Format(messg + "; Method started successfully"));
        ...
        public static AffectedRoadsStructure getRoadDetails(DrivingInstructionModel DrivingInstructionInfo, int legNumber)
        {
            ...
            string messg = "ProposalDAO/getRoadDetails?legNumber=" + legNumber;
            Logger.GetInstance().LogMessage(Log_Priority.INFORMATIONAL, string.Format(messg + "; Method started successfully"));
            ...
            var combination = lengthData.Aggregate((x, y) => x * y);

            string lengthDataString = string.Join(string.Empty, lengthData.ToArray());
            ...
            if (parentNode.Count >= 1)
            {
                ...
                foreach (XmlElement element in parentNode) // For SubPart
                {
                    ...
                    {
                        NavigationXML navigationXML = new NavigationXML();
                        ...
                        foreach (XmlElement newNode in alternativeElement)
                        {
                            ...
                            CheckTotalDistanceMetric = totalsmeric;
                        ...
                        arsps = new AffectedRoadsSubPartStructure();
                    }
        ...
        {
            string messg = "ProposalDAO/getDrivingDetails?incdoccaution=" + incdoccaution + ", legNumber=" + legNumber;
            Logger.GetInstance().LogMessage(Log_Priority.INFORMATIONAL, string.Format(messg + "; Method started successfully"));
            ...
            if (DrivingInstructionArray != null)
            {
                ...
                string dockCautionDescription = string.Empty;
                string motorwayCautionDescription = string.Empty;
                xmlDoc.GetElementsByTagName("PredefinedCautions");

                foreach (XmlElement xmlElements in node)//Instruction
                {
                    foreach (XmlElement xmlElement1 in xmlElements.ChildNodes)//Instruction
                    {
                        if (xmlElement1.Name == "DockCautionDescription")
                        {
                            dockCautionDescription = xmlElement1.InnerText;
                        }
                ...
                foreach (XmlElement xmlElement1 in node)//Instruction
                {
                    if (xmlElement1.Name == "DrivingInstructions")
                    {
                        ...
                        if (xmlElement1["LegNumber"] != null)
                        {
                            ...
                            legDetailsMessg = "ProposalDAO/getDrivingDetails-LegNumber=" + LegNumber;
                        ...
                        if (xmlElement1["Name"] != null)
                        {
                            ...
                            legDetailsMessg = "ProposalDAO/getDrivingDetails-Name=" + Name;
                            Logger.GetInstance().LogMessage(Log_Priority.INFORMATIONAL, string.Format(legDetailsMessg + "; In DrivingInstructions Element"));
                        }
                    }
                }
                        ...
                        foreach (XmlElement element in newElement) // For SubPart
                        {
                            foreach (XmlElement alternativeElement in element) // For AlternativeListPosition
                            {
                                ...
                                foreach (DrivingInstructionModel drivinginsstru in drivingInsList)
                                {
                                    ...
                                    ProposedRouteXSD.LevelTwoTextStructure[] ltsArray = new ProposedRouteXSD.LevelTwoTextStructure[1];
                                    ...
                                    for (int count = 0; count < drivinginsstru.ListDrivingInstructionModel.Count; count++)
                                    {
                                        ...
                                        if (drivinginsstru.ListDrivingInstructionModel[count].MotorwayCaution == true)
                                        {
                                        ...
                                        if (drivinginsstru.ListDrivingInstructionModel[count].AnnotationId != 0)
                                        {
                                            ...
                                            ProposedRouteXSD.SimpleTextStructure sts2 = new ProposedRouteXSD.SimpleTextStructure();
                                        ...
                                        if (drivinginsstru.ListDrivingInstructionModel[count].CautionId > 0)
                                        {
                                            ...
                                            ProposedRouteXSD.CautionedEntityChoiceStructure cecs = new ProposedRouteXSD.CautionedEntityChoiceStructure();
                                        ...
                                        if (drivinginsstru.ListDrivingInstructionModel[count].PointType != "" || drivinginsstru.ListDrivingInstructionModel[count].MotorwayCaution == true
                                        ...
                                        dins1 = new ProposedRouteXSD.DrivingInstructionNoteStructure();
        ...
        {
            string messg = "ProposalDAO/GetRecipientDetails?analysisID=" + analysisID + ", userSchema=" + userSchema;
            Logger.GetInstance().LogMessage(Log_Priority.INFORMATIONAL, string.Format(messg + "; Method started successfully"));
                            ...
                            foreach (XmlNode childNode in xmlElement1)                          //SimpleReference
                            {
                                ...
                                else if (childNode.Name.Contains("AdhocReference"))
                                {
                                                       ...
                                                       && (string.IsNullOrEmpty(exclude) || exclude.ToLower() == "false"))
                                    {
                                        ...
                                        contactInformationLog = "ProposalDAO/GetRecipientDetails?IS_RECIPIENT=" + contactInfo.IsRecipient + ", IS_HAULIER=" + contactInfo.IsHaulier + ", FAX=" + contactInfo.Fax + ", EMAIL=" + contactInfo.Email + ", IS_POLICE=" + contactInfo.ISPolice + ", IS_RETAINED_NOTIFICATION_ONLY=" + contactInfo.IsRetainedNotificationOnly + ", Reason=" + contactInfo.Reason + ", FULL_NAME=" + contactInfo.FullName + ", ORGANISATION=" + contactInfo.Organisation;
